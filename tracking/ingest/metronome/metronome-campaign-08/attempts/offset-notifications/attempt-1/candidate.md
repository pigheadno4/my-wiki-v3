...
- Enabling an offset is prospective. Metronome starts generating events from that point forward and does not create events for past data; a past fire time is not replayed, and archiving the offset before its fire time prevents delivery.
