...
- Parent commits can expose balance to all children, no children, or selected child contract IDs. The guide states that hierarchies can also share credits, but its worked access configurations are commit examples.
