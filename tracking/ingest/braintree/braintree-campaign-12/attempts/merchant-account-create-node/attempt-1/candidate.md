...
- The page links to a Merchant Account response object, a Braintree Marketplace overview, merchant-account result handling, and service-fee transaction creation. Those references are navigation routes; their behavior is not imported into this fully read source.
...
- Marketplace, result-handling and service-fee navigation routes: `## See also`, lines 110-115.
