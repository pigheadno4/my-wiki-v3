...
| braintree | `braintree/braintree-web` | tier1 | semver-tags / npm-tracked-source-v1 | weekly | 2026-07-28 | ingested | 2026-08-04 | `wait` |
| braintree | `braintree/braintree-web-drop-in` | tier1 | semver-tags / npm-tracked-source-v1 | weekly | 2026-07-28 | ingested | 2026-08-04 | `wait` |
...
| paypal | `paypal-examples/v6-web-sdk-sample-integration` | tier1 | commit / commit-tree-v1 | monthly | - | - | - | `collect-baseline` |
