...
> [!warning] Example syntax
> The current-period request example contains a trailing comma after `billing_provider_configuration_id`, and the next-period example is missing closing braces. They are not valid JSON as printed; use the documented field structure rather than copying either payload verbatim.

## Related

- Companies: [[metronome]], [[stripe]]
- Concepts: [[metronome-customers-and-contracts]], [[metronome-invoicing]], [[metronome-integrations]], [[metronome-credits-and-commits]]
- Related sources: [[source-metronome-integrations-invoice-integrations-stripe]], [[source-metronome-guides-customers-billing-optimize-customer-experience-prepaid-balance-thresholds]], [[source-metronome-api-reference-contracts-get-contract-edit-history]]

## Raw Sources

- [[raw/metronome/guides/customers-billing/manage-customers/schedule-billing-provider-change-2026-07-13|2026-07-13 snapshot — scheduled billing-provider transitions]]
