...
> [!info] Related credential boundary
> The security-principles guide's 12-hour credential lifetime applies to credentials minted by Metronome engineers. This API page does not assign that lifetime to customer-created bearer tokens.
