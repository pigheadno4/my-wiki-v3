...
- `mode` defaults to `replace`, which ignores historical usage; `merge` combines supplied events with the customer's existing usage.
...
- [[raw/metronome/api-reference/invoices/preview-events-2026-07-13|2026-07-13 snapshot — Preview Events API schema]]
