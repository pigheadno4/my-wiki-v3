...
> This guide says all `properties` keys and values should be strings. The separate ingest-endpoint reference remains the authority for the accepted OpenAPI object schema and batch limits.
