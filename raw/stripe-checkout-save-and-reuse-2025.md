<!-- Source: Stripe Checkout — Set up future payments -->
<!-- Fetched: 2026-04-20 -->
...
- **Asynchronously**: Handle `checkout.session.completed` _webhooks_ (A webhook is a real-time push notification sent to your application as a JSON payload through HTTPS requests), which contain a Session object. Learn more about [setting up webhooks](https://docs.stripe.com/webhooks.md).
