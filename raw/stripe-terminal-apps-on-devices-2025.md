<!-- Source URL: https://docs.stripe.com/terminal/features/apps-on-devices/overview -->
<!-- Fetched: 2026-05-01 -->
...
![](assets/stripe-terminal-apps-on-devices-pos-on-spos.png)
...
![](assets/stripe-terminal-apps-on-devices-app-on-cfd.png)
