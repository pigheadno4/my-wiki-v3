<!-- Source URL: https://developer.paypal.com/braintree/docs/guides/local-payment-methods/testing-go-live/node -->
<!-- Fetched: 2026-09-16 -->
<!-- Discovery: llms.txt,sitemap.xml -->

---
title: Testing and Go Live
slug: /docs/guides/local-payment-methods/testing-go-live/node/
createTime: '2025-04-01T23:17:24.615Z'
updateTime: '2025-04-01T23:17:24.649Z'
---
...
You can test your Local Payment Methods integration in the Braintree sandbox environment in 2 ways:


- [Mocked Local Payment Method testing](#mocked-local-payment-method-testing)(default)
...
- [Local Payment Method testing with linked PayPal account](#local-payment-method-testing-with-linked-paypal-account)
...
- Allows you to test the full functionality of your Local Payment Methods integration (e.g. transaction reporting, email receipts)
...
## Mocked Local Payment Method testing
...
Any testing you do in the mocked Local Payment Method flow will only be reflected in your Braintree sandbox – no data will be sent to your PayPal sandbox. If you'd like to do complete end-to-end testing, see[Local Payment Method testing with linked PayPal account](#local-payment-method-testing-with-linked-paypal-account).
## Local Payment Method testing with linked PayPal account
