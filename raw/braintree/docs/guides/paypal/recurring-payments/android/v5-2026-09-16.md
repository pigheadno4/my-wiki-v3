<!-- Source URL: https://developer.paypal.com/braintree/docs/guides/paypal/recurring-payments/android/v5 -->
<!-- Fetched: 2026-09-16 -->
<!-- Discovery: llms.txt,sitemap.xml -->

---
title: Recurring payments
slug: /docs/guides/paypal/recurring-payments/android/v5/
createTime: '2025-04-02T03:41:04.882Z'
updateTime: '2026-06-03T11:51:28.373Z'
---
...
```kotlin
 ...
 val billingPricing = PayPalBillingPricing(
    pricingModel = PayPalPricingModel.AUTO_RELOAD, // other options: FIXED, VARIABLE
    amount = "9.99",
    reloadThresholdAmount = "99.99"
)
val billingCycle = PayPalBillingCycle(
    interval = PayPalBillingInterval.MONTH, // other options: DAY, WEEK, YEAR
    intervalCount = 1,
...
val request = PayPalVaultRequest(
    ...
    recurringBillingPlanType = PayPalRecurringBillingPlanType.SUBSCRIPTION // other options: RECURRING, INSTALLMENT, UNSCHEDULED
)
```

## Checkout with Vault

If you want to collect a payment and create a billing agreement in a single checkout session, use the [Checkout with Vault](https://developer.paypal.com/braintree/docs/guides/paypal/checkout-with-vault/android/v5/) flow instead. That flow uses PayPalCheckoutRequest with shouldRequestBillingAgreement = true.
