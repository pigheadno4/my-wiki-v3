<!-- Source URL: https://developer.paypal.com/braintree/docs/guides/drop-in/customization/ios/v7 -->
<!-- Fetched: 2026-09-16 -->
<!-- Discovery: llms.txt,sitemap.xml -->

---
title: Customization
slug: /docs/guides/drop-in/customization/ios/v7/
createTime: '2025-11-21T07:23:06.198Z'
updateTime: '2026-09-02T14:45:23.246Z'
---
...
**NOTE**
 The iOS v7 SDK is not currently supported via the Drop-in SDK. Please see [the v5 implementation guide](/braintree/docs/guides/drop-in/overview/ios/v5) if using the Drop-in.
