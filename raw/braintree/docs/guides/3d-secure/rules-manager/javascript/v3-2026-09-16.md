<!-- Source URL: https://developer.paypal.com/braintree/docs/guides/3d-secure/rules-manager/javascript/v3 -->
<!-- Fetched: 2026-09-16 -->
<!-- Discovery: llms.txt,sitemap.xml -->

---
title: ' Rules Manager'
slug: /docs/guides/3d-secure/rules-manager/javascript/v3/
createTime: '2025-04-01T21:51:48.570Z'
updateTime: '2026-02-18T13:11:01.392Z'
---
...
![3DS,Rules](/braintree/files/3ds-rules.png) If multiple rules are matched for a given transaction, the higher priority rule will be applied, and other rules will be ignored. We recommend that merchants consistently monitor and adjust their rules based on transaction activity, performance, and industry trends.
...
### Javascript
```javascript
var verifyCardParams = { customFields: { retry_transaction: "true" } };
...
```javascript
var verifyCardParams = {
  customFields: { package_starts_within_5_days: "true" },
};
