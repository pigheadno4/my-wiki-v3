<!-- Source URL: https://developer.paypal.com/braintree/docs/guides/3d-secure/advanced-options/android/v5 -->
<!-- Fetched: 2026-09-16 -->
<!-- Discovery: llms.txt,sitemap.xml -->

---
title: Advanced Options
slug: /docs/guides/3d-secure/advanced-options/android/v5/
createTime: '2025-04-02T02:49:10.831Z'
updateTime: '2026-05-08T11:22:03.662Z'
---
...
To process non-network tokenized Google Pay cards for 3DS verification, include a GooglePaymentCardNonce as the nonce property on your ThreeDSecureRequest. See the [Google Pay configuration guide](/braintree/docs/guides/google-pay/configuration) for how to generate a GooglePaymentCardNonce. Once you have generated a nonce, you should check if your Google Pay nonce is non-network tokenized.
