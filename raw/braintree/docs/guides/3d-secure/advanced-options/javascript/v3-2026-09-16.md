<!-- Source URL: https://developer.paypal.com/braintree/docs/guides/3d-secure/advanced-options/javascript/v3 -->
<!-- Fetched: 2026-09-16 -->
<!-- Discovery: llms.txt,sitemap.xml -->

---
title: ' Advanced Options'
slug: /docs/guides/3d-secure/advanced-options/javascript/v3/
createTime: '2025-04-02T01:25:33.673Z'
updateTime: '2026-08-24T16:28:08.471Z'
---
...
When verifying a vaulted card, make sure to pass a  [customer_id](https://developer.paypal.com/braintree/docs/reference/request/client-token/generate#customer_id).
...
- Anon-network tokenized cardis a standard credit card. Access to the card's primary account number (PAN) makes 3DS verification possible.
- Anetwork tokenized cardis a generated virtual card with a device-specific account number (DPAN) that is used in place of the underlying source card. These cards cannot be used with 3DS.
...
To process non-network tokenized Google Pay cards for 3DS verification, include a Google Pay nonce as the `nonce` field on your `threeDSecureParameters`. See the [Google Pay configuration guide](/braintree/docs/guides/google-pay/configuration) for how to generate a Google Pay nonce. Once you have generated a nonce, you should check if your Google Pay nonce is non-network tokenized.
...
In the US, use 3DS Data-Only to enable the [Visa Digital Commerce Authentication Program](/braintree/docs/reference/general/enhanced-data/enable-dcap/) (DCAP) for eligible transactions and get interchange benefits. To enable Visa DCAP, check if you can send following DCAP data:
...
- [Email address](https://braintree.github.io/braintree-web/current/ThreeDSecure.html#verifyCard)
