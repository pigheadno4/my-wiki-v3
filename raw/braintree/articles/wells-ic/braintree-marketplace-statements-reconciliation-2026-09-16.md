<!-- Source URL: https://developer.paypal.com/braintree/articles/wells-ic/braintree-marketplace-statements-reconciliation -->
<!-- Fetched: 2026-09-16 -->
<!-- Discovery: llms.txt,sitemap.xml -->

---
title: IC+ Braintree Marketplace Statements and Reconciliation
slug: /articles/wells-ic/braintree-marketplace-statements-reconciliation/
createTime: '2025-04-01T23:44:29.956Z'
updateTime: '2025-04-01T23:44:29.981Z'
---



# IC+ Braintree Marketplace Statements and Reconciliation


**NOTE**
 If you are not using [Braintree Marketplace](/braintree/articles/guides/braintree-marketplace/overview), your statements will look different. See also the [standard statements and reconciliation guide](/braintree/articles/wells-ic/statements-reconciliation).
...
Interchange fees are billed based on when the transaction [settled](/braintree/articles/get-started/transaction-lifecycle), while Braintree fees are billed based on when the transaction was **disbursed**. Regardless of when the fees were calculated, both your interchange fees and Braintree fees will be debited on the second Tuesday of the following month in two separate withdrawals. Learn more about the [different types of fees](/braintree/articles/wells-ic/pricing-fees).
...
Most Braintree Marketplace merchants reconcile by comparing the Master Merchant Disbursement Details—which can be found on the second page of your Braintree statement—to the deposits they see in their bank accounts.
