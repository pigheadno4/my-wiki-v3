<!-- Source URL: https://docs.stripe.com/payments/link/checkout-link -->
<!-- Fetched: 2026-05-08 -->
...
![Add Link to your prebuilt checkout page](assets/stripe-link-in-checkout.png)
...
1. If you have an existing integration that manually lists payment methods, remove the [payment_method_types](https://docs.stripe.com/api/payment_intents/object.md#payment_intent_object-payment_method_types) parameter from your integration.
   ![Preview of Link enabled as payment method in the Stripe Dashboard](assets/stripe-link-enable-dashboard.png)
