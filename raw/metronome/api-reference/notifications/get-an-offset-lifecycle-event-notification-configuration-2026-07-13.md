<!-- Source URL: https://docs.metronome.com/api-reference/notifications/get-an-offset-lifecycle-event-notification-configuration.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.json post /v2/notifications/get
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
...
paths:
  /v2/notifications/get:
    post:
      ...
      description: >-
        Retrieve a specific offset lifecycle event notification configuration by
        ID.
