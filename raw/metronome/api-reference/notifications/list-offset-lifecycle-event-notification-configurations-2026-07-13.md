<!-- Source URL: https://docs.metronome.com/api-reference/notifications/list-offset-lifecycle-event-notification-configurations.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.json post /v2/notifications/offset/list
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
...
paths:
  /v2/notifications/offset/list:
    post:
      ...
      description: >
        List offset lifecycle event notification configurations. These are
        user-created notifications that trigger at a specified time offset
        relative to lifecycle events. Returns a maximum of 400 results per
        request.
      ...
      properties:
        ...
        archive_filter:
          ...
          enum:
            ...
            - ALL
          description: >-
            Filter options for the notification configurations. If not provided,
            defaults to NOT_ARCHIVED.
