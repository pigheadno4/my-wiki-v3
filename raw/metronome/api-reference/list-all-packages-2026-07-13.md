<!-- Source URL: https://docs.metronome.com/api-reference/list-all-packages.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.json post /v1/packages/list
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
              ...
              properties:
                archive_filter:
                  ...
                  enum:
                    ...
                    - all
                  description: >-
                    Filter packages by archived status. Defaults to
                    NOT_ARCHIVED.
            example: {}
      responses:
        '200':
