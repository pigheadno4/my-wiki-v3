<!-- Source URL: https://docs.metronome.com/api-reference/credit-grants/void-a-credit-grant.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.plans.json post /credits/voidGrant
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
...
paths:
  /credits/voidGrant:
    post:
      ...
      description: >
        Void a credit grant. This is a Plans (deprecated) endpoint. New clients
            ...
            schema:
              ...
              properties:
                ...
                release_uniqueness_key:
                  type: boolean
                  description: >-
                    If true, resets the uniqueness key on this grant so it can
                    be re-used
            example:
