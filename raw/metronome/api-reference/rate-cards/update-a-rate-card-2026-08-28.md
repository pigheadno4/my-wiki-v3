...
paths:
  /v1/contract-pricing/rate-cards/update:
    post:
      ...
      description: >
        Update a rate card's name, description, aliases, and credit type
        conversion rates. This endpoint does not affect underlying pricing rates
        or schedules.


        ### Use this endpoint to:

        - Rename rate cards: Update display names or descriptions for
        organizational clarity

        - Manage aliases: Add, modify, or schedule alias transitions for
        seamless and code-free rate card migrations

        - Update documentation: Keep rate card descriptions current with
        business context

        - Configure custom pricing units: Add credit type conversions to enable
        rates with different pricing units
      ...
      requestBody:
        description: >-
          Update a rate card. Must provide at least one of name, description,
          aliases, or addCreditTypeConversions.
        content:
          application/json:
            schema:
