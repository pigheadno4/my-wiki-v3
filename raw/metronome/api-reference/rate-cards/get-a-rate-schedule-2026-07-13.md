<!-- Source URL: https://docs.metronome.com/api-reference/rate-cards/get-a-rate-schedule.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.json post /v1/contract-pricing/rate-cards/getRateSchedule
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
    ...
    GetRateSchedulePayload:
      ...
      properties:
        ...
        ending_before:
          ...
          format: date-time
          description: >-
            optional exclusive end date for the rates schedule. When not
