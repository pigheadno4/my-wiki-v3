<!-- Source URL: https://docs.metronome.com/api-reference/rate-cards/set-the-rate-card-products-order.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.json post /v1/contract-pricing/rate-cards/setRateCardProductsOrder
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
  ...
  /v1/contract-pricing/rate-cards/setRateCardProductsOrder:
    post:
      ...
      description: >
        ...
        set the order of products on the rate card.
