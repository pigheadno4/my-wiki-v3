<!-- Source URL: https://docs.metronome.com/api-reference/rate-cards/add-a-rate.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.json post /v1/contract-pricing/rate-cards/addRate
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
  ...
  /v1/contract-pricing/rate-cards/addRate:
    post:
      ...
      description: >
        ...
        This endpoint is heavily rate limited. For adding multiple rates, using
        the
