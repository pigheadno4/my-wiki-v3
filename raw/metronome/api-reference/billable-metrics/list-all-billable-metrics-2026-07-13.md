<!-- Source URL: https://docs.metronome.com/api-reference/billable-metrics/list-all-billable-metrics.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.json get /v1/billable-metrics
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
  ...
  /v1/billable-metrics:
    get:
      ...
      description: >
        ...
        Important: Archived metrics are excluded by default; use
