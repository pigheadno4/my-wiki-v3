<!-- Source URL: https://docs.metronome.com/api-reference/plans/list-plans.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.plans.json get /plans
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
...
paths:
  /plans:
    get:
      ...
      summary: List plans
      description: >-
        List all available plans. This is a Plans (deprecated) endpoint. New
