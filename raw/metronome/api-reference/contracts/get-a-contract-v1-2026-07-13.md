<!-- Source URL: https://docs.metronome.com/api-reference/contracts/get-a-contract-v1.md -->
<!-- Fetched: 2026-07-13 -->
...
````yaml /openapi.json post /v1/contracts/get
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
...
paths:
  /v1/contracts/get:
    post:
      ...
      description: >
        This is the v1 endpoint to get a contract. New clients should implement
