<!-- Source URL: https://docs.metronome.com/api-reference/products/list-products.md -->
<!-- Fetched: 2026-08-28 -->
...
````yaml /openapi.json post /v1/contract-pricing/products/list
openapi: 3.0.1
info:
  title: Metronome
  version: 1.0.0
      ...
      properties:
        archive_filter:
          ...
          enum:
            ...
            - ALL
          description: >-
            Filter options for the product list. If not provided, defaults to
            not archived.
    ProductListItem:
      type: object
      required:
