...
1. In the [Metronome app](https://app.metronome.com/), click **Connections** in the left sidebar.
...
1. Go to **Connections** on the left sidebar and open the **Integrations** tab.
