...
1. Authenticate your Stripe account from Metronome. Go to [Developer - Integrations](https://app.metronome.com/settings/general/integrations) → click **Enable** and complete the Stripe wizard.
...
If you use a tax provider not listed above, or if you’re not using Stripe for invoicing, contact us via the [Metronome support portal](https://support.metronome.com/) for guidance on configuring tax.
...
| **Stripe does not allow a charge above 999,999.99 USD**          | Metronome generates an error when creating an invoice with an amount above the Stripe maximum. Contact your Stripe representative and use the [Metronome support portal](https://support.metronome.com/) to increase the limit if you need invoices with amounts above \$999,999.99.                                                                                                                       |
