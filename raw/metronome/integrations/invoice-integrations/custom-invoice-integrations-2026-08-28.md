...
For more information on how to set up a managed integration, contact [solutions@metronome.com](mailto:solutions@metronome.com).
...
<Note>
  **NOTE**
  ...
  The `invoice.finalized` event is not enabled by default for Metronome clients. To turn this event on, contact us via the [Metronome support portal](https://support.metronome.com/).
</Note>
...
For more information on integrating with the API or leveraging public connectors, contact us via the [Metronome support portal](https://support.metronome.com/).
