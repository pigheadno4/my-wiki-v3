...
The invoice dashboard allows your customers to view their current and historical invoices (draft, finalized, and voided), up to 90 days old. For clients using Metronome's invoicing product, your customers can also manually attempt payment on outstanding invoices.
