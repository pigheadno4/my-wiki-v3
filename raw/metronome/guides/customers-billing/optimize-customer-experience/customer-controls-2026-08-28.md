...
Taking action on notifications in real time requires the use of webhooks—dedicated endpoints in your application for receiving and processing notifications. Configure webhooks in Metronome in under [Developer - Notifications - Webhooks](https://app.metronome.com/developer/notifications/webhooks).
