<!-- Source URL: https://docs.stripe.com/billing/subscriptions/modify -->
<!-- Fetched: 2026-05-13 -->
...
- _Non-billing updates_ apply immediately without prorations. These include updating metadata, payment methods, tax settings, or [applying or removing discounts](https://docs.stripe.com/billing/subscriptions/coupons.md#update-a-subscription).
