<!-- Source URL: https://docs.stripe.com/payment-links/customize -->
<!-- Fetched: 2026-04-20 -->
...
const paymentLink = await stripe.paymentLinks.create({
  ...
  inactive_message: "Sorry, we're out of stock for now!",
});
```
...
![](assets/customize-payment-link.8d578e56ad9a6171b4763b46e027aa01.png)

After your customer completes the payment, you can view the fields on the payment details page in the Dashboard.
![](assets/payment.56e708902bb56215b40e523371418a6e.png)

The custom fields are also included in the [checkout.session.completed](https://docs.stripe.com/api/events/types.md#event_types-checkout.session.completed) _webhook_ (A webhook is a real-time push notification sent to your application as a JSON payload through HTTPS requests) upon payment completion.
