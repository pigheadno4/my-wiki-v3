<!-- Source URL: https://docs.stripe.com/payments/link/invoicing -->
<!-- Fetched: 2026-05-08 -->
...
![Link in the Hosted Invoice Page](assets/stripe-link-in-hosted-invoice.png)
...
1. Find Link, toggle it on, and click **Save**.
