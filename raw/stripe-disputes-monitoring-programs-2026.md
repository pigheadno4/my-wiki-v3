<!-- Source URL: https://docs.stripe.com/disputes/monitoring-programs -->
<!-- Fetched: 2026-05-10 -->
...
Monitoring your chargeback and fraud levels accurately is important. For example, Mastercard counts a chargeback regardless of whether it was hidden due to a refund, regardless of _liability shift_ (With some 3D Secure transactions, the liability for fraudulent chargebacks (stolen or counterfeit cards) shifts from you to the card issuer), and regardless of its outcome.
