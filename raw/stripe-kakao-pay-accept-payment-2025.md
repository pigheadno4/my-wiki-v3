<!-- Source URL: https://docs.stripe.com/payments/kakao-pay/accept-a-payment -->
<!-- Fetched: 2026-05-08 -->
...
> This is a Checkout for when payment-ui is checkout. View the full page at https://docs.stripe.com/payments/kakao-pay/accept-a-payment?payment-ui=checkout.
...
**Supported business locations**: AT, BE, CY, DE, DK, EE, ES, FI, FR, GB, GR, HK, HR, HU, IE, IT, JP, LT, LU, LV, MT, NL, PT, SE, SI, SK, US
...
- The minimum amount accepted is 100 KRW. There is no maximum limit for card passthrough transactions, while the maximum amount that a customer can top up to their Kakao Pay account as stored value is 2,000,000 KRW.
...
> This is a Direct API for when payment-ui is direct-api. View the full page at https://docs.stripe.com/payments/kakao-pay/accept-a-payment?payment-ui=direct-api.
