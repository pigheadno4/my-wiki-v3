---
title: Pay with PayPal for recurring payments
slug: /docs/checkout/standard/best-practices/recurring/
createTime: '2025-01-09T21:31:27.191Z'
updateTime: '2025-08-12T17:39:06.171Z'
---
...
![Three smartphone screenshots demonstrating a simplified subscription sign-up integration for recurring payments.](assets/paypal-best-practices-recurring-subscription.png)
...
- Ensure that the order card shows plan information and a recurring indicator for greater transparency. The buyer can review this information on the PayPal review page before accepting the terms. See Save payment methods for recurring payments for more information.
- If you have the buyer's email address, pass it during order creation. See the Pass buyer identifier guide for more information.

![Screenshot showing example recurring payments implementation on the PayPal review page.](assets/paypal-best-practices-recurring-implementation.png)

## Best practices for saving payment methods during purchase

Integrate a Shipping module to capture shipping addresses during the first purchase when recurring payments involve physical goods.
...
- **Recurring payments module** — Display recurring payment information to the payer before they commit to the payment.
