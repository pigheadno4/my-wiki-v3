<!-- Source: Stripe Checkout — Analyze your conversion funnel -->
<!-- Fetched: 2026-04-20 -->
...
1. Create a canceled page:
   ...
   <html>
     ...
     <body>
       <p><a href="/product">Start another order</a>.</p>
     </body>
   </html>
   ```
