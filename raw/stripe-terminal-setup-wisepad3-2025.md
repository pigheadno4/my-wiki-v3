<!-- Source: Stripe Terminal — Set up BBPOS WisePad 3 -->
<!-- Fetched: 2026-04-24 -->

# Set up BBPOS WisePad 3

Learn how to set up the BBPOS WisePad 3.
Available in: CA, GB, IE, SG, AU, NZ, FR, DE, NL, BE, AT, ES, DK, SE, NO, CH, IT, LU, PT, FI, MY, CZ, PL, JP![](assets/stripe-terminal-wisepad3-floating.png)
