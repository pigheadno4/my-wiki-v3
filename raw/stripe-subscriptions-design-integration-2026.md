<!-- Source URL: https://docs.stripe.com/billing/subscriptions/design-an-integration -->
<!-- Fetched: 2026-05-12 -->
...
| ![An example of the flat rate pricing model that shows three service levels.](assets/stripe-subs-pricing-flat-rate.png)                |
...
| ![An example of the per-seat pricing model that shows a per-seat plan for software licenses.](assets/stripe-subs-pricing-per-seat.png) |
