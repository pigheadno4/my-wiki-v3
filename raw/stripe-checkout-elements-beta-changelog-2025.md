<!-- Source URL: https://docs.stripe.com/checkout/elements-with-checkout-sessions-api/changelog -->
<!-- Fetched: 2026-04-22 -->
...
const stripe = new Stripe('<<YOUR_SECRET_KEY>>', {
  apiVersion: '2026-03-25.dahlia; custom_checkout_beta=v1' as any,
});
```
...
_This is the initial front-end beta version._
...
_There are no changes to the back-end beta version._
