<!-- Source URL: https://docs.stripe.com/terminal/readers/stripe-reader-s700-s710 -->
<!-- Fetched: 2026-05-01 -->
...
![Front and back view of the Stripe Reader S700/S710](assets/stripe-terminal-s700.png)
...
If you’re connecting the Stripe Reader S700/S710 to a computer or laptop, make sure the USB-C port can support the recommended 12W of power. The USB-A port standard _does not_ support this power level—_do not_ use it.
...
| ---------------------------- | ---------- | ------------ | ---------------------- | -------- |
| US                           | `2.41.2.0` | `1.00.03.00` | `szzz_us_v11`          | `2.2.22` |
| CA                           | `2.41.2.0` | `1.00.03.00` | `szzz_ca_v4`           | `2.2.22` |
| AU                           | `2.41.2.0` | `1.00.03.00` | `szzz_prod_au_v11`     | `2.2.22` |
| MYNZ                         | `2.41.2.0` | `1.00.03.00` | `szzz_prod_apac_on_v5` | `2.2.22` |
| SG                           | `2.41.2.0` | `1.00.03.00` | `szzz_prod_apac_on_v5` | `2.2.22` |
| GBIEFI                       | `2.41.2.0` | `1.00.03.00` | `szzz_prod_eu_off_v3`  | `2.2.22` |
| ATBEDKFRITDENLESSECZLUPTCHNO | `2.41.2.0` | `1.00.03.00` | `szzz_prod_eu_on_v5`   | `2.2.22` |

### Reader software changelog

> If you use software acceptance, see the [Terminal bundle release notes](https://docs.stripe.com/terminal/fleet/software-acceptance/release-notes.md) instead.
