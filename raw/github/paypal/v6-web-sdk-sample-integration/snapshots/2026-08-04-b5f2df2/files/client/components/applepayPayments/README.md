...
2. **Register ngrok domain with PayPal:**
   ...
   - Before clicking **Register Domain**, download and save the domain association file to `.well-known/apple-developer-merchantid-domain-association` ([more info](https://developer.apple.com/documentation/applepaywebmerchantregistrationapi/preparing-merchant-domains-for-verification#Host-the-domain-verification-file))
