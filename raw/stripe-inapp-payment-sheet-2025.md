<!-- Source URL: https://docs.stripe.com/payments/mobile/payment-sheet -->
<!-- Fetched: 2026-04-22 -->
...
> ![Payment Sheet integration example](assets/stripe-inapp-payment-sheet-example.png)
...
![Payment Sheet layout options](assets/stripe-inapp-ps-layout.png)
...
![Payment Sheet appearance customization](assets/stripe-inapp-ps-appearance.png)
...
![Payment Sheet payment methods](assets/stripe-inapp-ps-payment-methods.png)
...
![Payment Sheet wallets](assets/stripe-inapp-ps-wallets.png)
...
- Preventing buyers from removing the last saved payment method
  ![Payment Sheet saved payment methods](assets/stripe-inapp-saved-payment-methods.png)
...
![Payment Sheet address collection](assets/stripe-inapp-ps-address-collection.png)
