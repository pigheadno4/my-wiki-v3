<!-- Source URL: https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment -->
<!-- Fetched: 2026-05-01 -->
...
Some restrictions apply to which transactions and cards can use installments. Review the [compatibility requirements](https://docs.stripe.com/payments/mx-installments.md#requirements).

Accepting an installment payment incurs [an additional fee](https://docs.stripe.com/payments/mx-installments.md#fees) to the standard credit card transaction fee.
...
> This is a Checkout for when payment-ui is checkout. View the full page at https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment?payment-ui=checkout.
...
> This is a Elements for when payment-ui is elements. View the full page at https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment?payment-ui=elements.
...
> This is a Direct API for when payment-ui is direct-api. View the full page at https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment?payment-ui=direct-api.
...
A diagram providing a high level overview of a payment integration that accepts installments using the Payment Intents API (See full diagram at https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment)

1. [Collect payment method details on the client](https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment.md#collect-payment-method)
1. [Retrieve installment plans on the server](https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment.md#retrieve-installment-plans)
1. [Select an installment plan on the client](https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment.md#select-plan)
1. [Confirm the PaymentIntent on the server](https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment.md#confirm-payment)
...
> This is a Invoices for when payment-ui is invoices. View the full page at https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment?payment-ui=invoices.
...
1. [Review Invoicing documentation](https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment.md#review-invoicing-documentation)
1. [Create a new Invoice](https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment.md#create-new-invoice)
1. [Select an Installment plan on the client](https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment.md#select-plan)
1. [Retrieve the selected Installment plan](https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment.md#retrieve-plan)
...
1. On the [Customers](https://dashboard.stripe.com/customers) page, click **Add customer** to create a new customer (select the country as **Mexico**, language as **Spanish (Latin America)**, and currency as **MXN - Mexican Peso**)
...
> This is a No code for when payment-ui is payment-links. View the full page at https://docs.stripe.com/payments/meses-sin-intereses/accept-a-payment?payment-ui=payment-links.
...
## Enable installments for Payment Links

Enable installments for Payment Links in the payment methods settings page of the [Dashboard](https://dashboard.stripe.com/settings/payment_methods).

Configure which monthly plans to offer and the minimum and maximum transaction amounts for each plan. These plan configurations apply to all of your existing installments integrations.
