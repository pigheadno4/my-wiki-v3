<!-- Source URL: https://docs.stripe.com/terminal/readers/bbpos-wisepos-e -->
<!-- Fetched: 2026-05-01 -->

# BBPOS WisePOS E

Learn about the BBPOS WisePOS E reader.
Available in: US, CA, GB, IE, SG, AU, NZ, FR, DE, NL, BE, AT, ES, DK, SE, NO, CH, IT, LU, PT, FI, MY, CZ, PL![](assets/stripe-terminal-wisepos-e.png)
...
| ---------------------------- | ---------- | ------------------- | ----------------------- | ------- |
| US                           | `2.41.2.0` | `5.01.03.00`        | `szzz_us_v19`           | `1.8.4` |
| CA                           | `2.41.2.0` | `5.01.03.00`        | `szzz_ca_v17`           | `1.8.4` |
| AU                           | `2.41.2.0` | `5.01.03.00.eftpos` | `szzz_prod_au_v11`      | `1.8.4` |
| MYNZ                         | `2.41.2.0` | `5.01.03.00`        | `szzz_prod_apac_on_v4`  | `1.8.4` |
| SG                           | `2.41.2.0` | `5.01.03.00`        | `szzz_prod_apac_off_v4` | `1.8.4` |
| GBIEFI                       | `2.41.2.0` | `5.01.03.00`        | `szzz_prod_eu_off_v11`  | `1.8.4` |
| ATBEDKFRITDENLESSECZLUPTCHNO | `2.41.2.0` | `5.01.03.00`        | `szzz_prod_eu_on_v7`    | `1.8.4` |
