---
title: Integrate BLIK using the Orders API
slug: /docs/checkout/apm/blik/orders-api/
createTime: "2024-12-10T07:38:53.662Z"
updateTime: "2025-03-18T23:24:32.576Z"
---
...
- Request approval to enable BLIK by visiting the following sandbox and live links: - Sandbox: [https://www.sandbox.paypal.com/bizsignup/entry?product=blik&capabilities=BLIK&country.x=&lt;merchant's country&gt;](https://www.sandbox.paypal.com/bizsignup/entry?product=blik&capabilities=BLIK&country.x=)
- Live: [https://www.paypal.com/bizsignup/add-product?product=blik&capabilities=BLIK&country.x=&lt;merchant's country&gt;](https://www.paypal.com/bizsignup/add-product?product=blik&capabilities=BLIK&country.x=&_ga=1.63493231.1793812298.1735285121)
...
- Make sure you're [subscribed to the following webhook events](/docs/checkout/apm/reference/subscribe-to-webhooks/) : - PAYMENT.CAPTURE.COMPLETED - Listen for this webhook to get notified about a successful order capture.
...
```javascript
{
  ...
  "links": [
    ...
    {
      "href": "https://sandbox.paypal.com/payment/blik?token=7S180378AE2002441",
      "rel": "payer-action",
      "method": "GET"
    }
  ]
...
**Notes:**- order ID from [Step 2](#create-an-order) should match resource.supplementary_data.related_ids.order_id parameter in the webhook payload of PAYMENT.CAPTURE.COMPLETED and PAYMENT.CAPTURE.DENIED .
...
```javascript
curl -v -X GET https://api-m.sandbox.paypal.com/v2/checkout/orders/7S180378AE2002441 \
-H "Content-Type: application/json" \
-H "Authorization: Bearer <Access-Token>"
```
