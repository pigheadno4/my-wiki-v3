<!-- Source URL: https://docs.stripe.com/elements/appearance-api/mobile -->
<!-- Fetched: 2026-04-22 -->
...
1. Fine-tune [specific components](https://docs.stripe.com/elements/appearance-api/mobile.md#specific-ui-components-ios)
   ![](assets/stripe-inapp-ios-appearance-example.png)
...
![](assets/stripe-inapp-ios-appearance-colors.png)
...
![](assets/stripe-inapp-ios-appearance-shapes.png)
...
1. Fine-tune [specific components](https://docs.stripe.com/elements/appearance-api/mobile.md#specific-ui-components-android)
   ![](assets/stripe-inapp-android-appearance-example.png)
...
> ![](assets/stripe-inapp-android-appearance-colors.png)
...
![](assets/stripe-inapp-android-appearance-shapes.png)
...
![](assets/stripe-inapp-rn-appearance-shapes.png)
