<!-- Source: Stripe Checkout — Subscription upsells -->
<!-- Fetched: 2026-04-20 -->
...
![Configure a subscription upsell on the Price details page](assets/stripe-checkout-upsell-add.gif)
...
![Toggle between the initial price option and the upsell price option](assets/stripe-checkout-upsell-preview.gif)
...
![Remove an upsell](assets/stripe-checkout-upsell-remove.gif)
