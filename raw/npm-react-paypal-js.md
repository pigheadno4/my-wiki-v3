...
9.1.1 • Public • Published 8 days ago
...
All field components (PayPalCardNumberField, PayPalCardExpiryField, PayPalCardCvvField) accept the same set of props.
...
Note: One-time payment session hooks accept either a static orderId or a createOrder callback — they are mutually exclusive. Use orderId when you've already created the order, or createOrder to defer order creation until the buyer clicks. The same pattern applies to save payment hooks with vaultSetupToken vs createVaultToken.
...
Use these hooks to handle the Card Fields payment flows. The hooks must be used within a PayPalCardFieldsProvider component.
...
- Version: 9.1.1
- License: Apache-2.0
- Weekly Downloads: 269,291
- Repository: github.com/paypal/paypal-js
- Homepage: paypal.github.io/paypal-js/web-sdk-v6-react-storybook/
