<!-- Source URL: https://docs.stripe.com/payments/link/instant-bank-payments -->
<!-- Fetched: 2026-05-08 -->
...
![Payment page](assets/stripe-ibp-bank-tab.png)

Under **Payment details**, they select **Bank**, then search for and select their bank.
![Link agreement page](assets/stripe-ibp-consent.png)

They click **Agree and continue**.
![Link login or sign up page](assets/stripe-ibp-sign-up.png)

They enter their email and click **Continue with Link**.
![Bank login page](assets/stripe-ibp-oauth.png)

They enter their bank login credentials and click **Submit**.
![Link success page](assets/stripe-ibp-success.png)
...
Under **Payment details**, they select **Bank**, then search for and select their bank.
![Link Welcome Back page](assets/stripe-ibp-returning.png)

They enter their email and click **Continue with Link**.
![2FA confirmation page](assets/stripe-ibp-otp.png)

They enter their 2FA confirmation code.
![Link select account page](assets/stripe-ibp-saved.png)
...
![2 day settlement timeline](assets/stripe-ibp-settlement-timing.png)
