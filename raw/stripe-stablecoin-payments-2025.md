<!-- Source URL: https://docs.stripe.com/payments/stablecoin-payments -->
<!-- Fetched: 2026-05-01 -->
...
Stablecoin payments allow you to accept _stablecoins_ (A cryptocurrency that's pegged to the value of a fiat currency or other asset in order to limit volatility) from customers around the world. Customers can pay with their preferred crypto wallet, token, and payment network, while completed stablecoin payments settle in your Stripe balance in USD.
