<!-- Source URL: https://docs.stripe.com/payments/kr-card/accept-a-payment -->
<!-- Fetched: 2026-05-08 -->
...
> This is a Checkout for when payment-ui is checkout. View the full page at https://docs.stripe.com/payments/kr-card/accept-a-payment?payment-ui=checkout.
...
When a customer makes a payment, they’re redirected to the checkout page of our local processor partner to authenticate and authorize the payment. After the customer authorizes the payment, Stripe redirects them back to your site.
![](assets/stripe-kr-card-payment-flow.mov)
...
> This is a Direct API for when payment-ui is direct-api. View the full page at https://docs.stripe.com/payments/kr-card/accept-a-payment?payment-ui=direct-api.
