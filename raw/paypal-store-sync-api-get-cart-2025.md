<!-- Source URL: https://docs.paypal.ai/reference/api/rest/cart-operations/get-cart-details -->
<!-- Fetched: 2026-04-18 -->
...
> Retrieves the current state of a cart. Used by PayPal Shopping Cart to check
> cart status, validation issues, and current totals.

**Error Handling:**

- **400 Bad Request**: Cart ID format is invalid (e.g., doesn't match expected pattern)
- **401 Authentication Failed**: Authentication failed with a list of possible issues
- **404 Not Found**: Cart ID is well-formed but doesn't exist in merchant's system
- **500 Internal Server Error**: System error during cart retrieval

## OpenAPI

````yaml /api-reference/paypal-cart-agentic-commerce-v1.yaml get /merchant-cart/{cartId}
openapi: 3.0.3
info:
...
paths:
  /merchant-cart/{cartId}:
    get:
      ...
      description: >
        Retrieves the current state of a cart. Used by PayPal Shopping Cart to
        check
        ...
        **Error Handling:**
        ...
        - **400 Bad Request**: Cart ID format is invalid (e.g., doesn't match
        expected pattern)

        - **401 Authentication Failed**: Authentication failed with a list of
        possible issues

        - **404 Not Found**: Cart ID is well-formed but doesn't exist in
        merchant's system  
      ...
      parameters:
        - name: cartId
          in: path
          required: true
          description: The cart identifier returned from cart creation
          schema:
            type: string
            example: CART-123
        - name: Authorization
        ...
        "200":
          ...
          content:
            application/json:
              ...
              examples:
                cart_basic:
                  summary: Cart - basic item with complete information
                  value:
                    id: CART-CREATED-001
                    status: CREATED
                    ...
                    totals:
                      ...
                      total:
                        currency_code: USD
                        value: "30.30"
                cart_with_validation_issues:
                  summary: Cart with out of stock item requiring resolution
                  value:
                    id: CART-ISSUES-003
                    status: INCOMPLETE
        ...
        "400":
          ...
          content:
            application/json:
              ...
              examples:
                invalid_cart_id_format:
                  summary: Malformed cart ID parameter
                  value:
        ...
        "404":
          ...
          content:
            application/json:
              ...
              examples:
                cart_not_found:
                  summary: Cart ID does not exist in merchant's system
                  value:
                    name: CART_NOT_FOUND
