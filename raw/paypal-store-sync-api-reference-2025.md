<!-- Source URL: https://docs.paypal.ai/reference/api/rest/cart-operations/create-cart -->
<!-- Fetched: 2026-04-18 -->
...
> Creates a new cart with the provided PayPalCart object. This is called by PayPal Shopping Cart
> when an AI agent or customer initiates a checkout process.

**Returns:**

- `201 Created`: Cart created successfully with payment token in payment_method
- `200 OK` + `validation_issues`: Business logic issues that need resolution
- `400 Bad Request`: Invalid request format
- `401 Authentication Failed`: Authentication failed with a list of possible issues
- `422 Unprocessable Entity`: Validation errors in cart data
- `500 Internal Server Error`: System errors

## OpenAPI

````yaml /api-reference/paypal-cart-agentic-commerce-v1.yaml post /merchant-cart
openapi: 3.0.3
info:
...
paths:
  /merchant-cart:
    post:
      ...
      summary: Create cart
      description: >
        Creates a new cart with the provided PayPalCart object. This is called
        by PayPal Shopping Cart
        ...
        **Returns:**
        ...
        - `201 Created`: Cart created successfully with payment token in
        payment_method

        - `200 OK` + `validation_issues`: Business logic issues that need
        resolution

        - `400 Bad Request`: Invalid request format

        - `401 Authentication Failed`: Authentication failed with a list of
        possible issues
      ...
      requestBody:
        ...
        content:
          application/json:
            ...
            examples:
              cart:
                summary: Cart with customer and shipping
                value:
                  items:
        ...
        "201":
          ...
          content:
            application/json:
              ...
              examples:
                cart_created:
                  summary: Cart with quantity (201)
                  value:
                    id: CART-US-002
                    status: CREATED
                ...
                simple_validation_example:
                  summary: Simple validation error - minimal required fields only
                  value:
                    id: CART-SIMPLE-001
                    status: INCOMPLETE
                ...
                shipping_validation_examples:
                  summary: Shipping address and restriction validation errors
                  value:
                    id: CART-SHIPPING-001
                    status: INCOMPLETE
                    validation_status: INVALID
                    validation_issues:
                      - code: SHIPPING_ERROR
                        ...
                        context:
                          specific_issues: SHIPPING_ADDRESS_INVALID
                          validation_failures:
                            - invalid_postal_code
                          provided_address: Main Street, Somewhere, CA, 9999X
                ...
                business_rule_validation_examples:
                  summary: Business rules and compliance validation errors
                  value:
                    id: CART-BUSINESS-001
                    status: INCOMPLETE
                    validation_status: INVALID
                    validation_issues:
                      - code: BUSINESS_RULE_ERROR
                        type: BUSINESS_RULE
                        message: Order total is below minimum required amount
                        user_message: >-
                          Orders must be at least $25.00. Add $10.01 more to
                          continue.
                        context:
                          specific_issue: MINIMUM_ORDER_NOT_MET
                          current_total: "14.99"
                          minimum_required: "25.00"
                          shortage_amount: "10.01"
                          currency_code: USD
                        resolution_options:
                          - action: MODIFY_CART
                            ...
                            metadata:
                              ...
                              cost_impact: +$10.01
                item_out_of_stock:
                  summary: Item out of stock with alternatives
                  value:
                    id: CART-OOS-005
                    status: INCOMPLETE
                    validation_status: INVALID
                    validation_issues:
                      - code: INVENTORY_ISSUE
                        ...
                        message: Product is no longer available
                        user_message: >-
                          The Running Shoes in size 10 are temporarily out of
                          stock. Would you like to try size 9.5 or 10.5?
                        variant_id: SHOE-RUNNING-001
                        context:
                          specific_issue: ITEM_OUT_OF_STOCK
                          available_quantity: 0
                          requested_quantity: 2
                          suggested_alternatives:
                            - SHOE-RUNNING-001-BLACK-9.5
                            - SHOE-RUNNING-001-BLACK-10.5
                          restock_date: "2024-07-15T00:00:00Z"
                        resolution_options:
                          - action: SUGGEST_ALTERNATIVE
                            label: Try size 9.5 or 10.5
                            metadata:
                              priority: HIGH
                              auto_applicable: true
        "400":
