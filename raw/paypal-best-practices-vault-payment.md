...
slug: /docs/checkout/standard/best-practices/vault/
createTime: '2025-01-23T17:22:17.793Z'
updateTime: '2025-09-17T11:38:37.960Z'
---

# Pay with PayPal for vaulted payments

![Three smartphone screenshots demonstrating a simplified onboarding integration for vaulted payments.](assets/paypal-best-practices-vault-onboarding.png)
...
This flow is recommended for business models where the average transaction size is less than $40. For business models where the customer actively initiates a purchase and the purchase does not involve a recurring payment, we recommend One-time payments.

## Purpose

This guide provides best practices for merchants who want to store PayPal as a payment method and streamline repeat transactions in mobile-first scenarios such as ordering food or taking a ride.

Using these tips to support online-to-offline (O2O) use cases makes it easier for your customers to confidently save, manage, and use PayPal for frictionless repeat transactions.
...
![Screenshot showing PayPal preselection during onboarding for vaulted payments.](assets/paypal-best-practices-vault-onboarding-preselect.png)
...
- **Native Apps**: Use the PayPal Native SDK to enable low-friction login experiences in fully native apps.
...
![Screenshot showing frictionless login options across native, hybrid, and web surfaces.](assets/paypal-best-practices-vault-frictionless-login.png)
