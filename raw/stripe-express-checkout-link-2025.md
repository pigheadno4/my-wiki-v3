<!-- Source URL: https://docs.stripe.com/payments/link/express-checkout-element-link -->
<!-- Fetched: 2026-05-08 -->
...
- Integrate Elements seamlessly by reusing an existing Elements instance to save time.
  ![Add Link to the Express Checkout Element](assets/stripe-link-express-checkout-element.png)
