<!-- Source: Stripe — Migrate to the Payment Element with the Checkout Sessions API -->
<!-- Fetched: 2026-04-21 -->
...
const { errors } = await checkoutState.checkout.confirm({
