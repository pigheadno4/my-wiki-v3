<!-- Source: Stripe Checkout — Extend checkout with custom components -->
<!-- Fetched: 2026-04-20 -->
...
When your customer completes the Checkout Session, we send a [checkout.session.completed](https://docs.stripe.com/api/events/types.md#event_types-checkout.session.completed) _webhook_ (A webhook is a real-time push notification sent to your application as a JSON payload through HTTPS requests) with the completed fields.
...
![](assets/stripe-checkout-custom-field-optional.png)
...
![A checkout page with a dropdown field](assets/stripe-checkout-custom-field-dropdown.png)
...
![A field with character limits](assets/stripe-checkout-custom-field-validation.png)
...
![Custom text near shipping address collection](assets/stripe-checkout-custom-text-shipping-address.png)

Custom text near the shipping address collection fields
![Custom text above the pay button](assets/stripe-checkout-custom-text-submit.png)

Custom text above the **Pay** button
![Custom text below the pay button](assets/stripe-checkout-custom-text-after-submit.png)
...
![A checkout page with contact information.](assets/stripe-checkout-contact-modal.png)

Preview of contact information on Checkout.
![A checkout page with legal policies.](assets/stripe-checkout-legal-modal.png)
...
![Preview of return policies on Checkout](assets/stripe-checkout-return-policy-modal.png)

Preview of return policies on Checkout.
![Preview of a policy highlight on Checkout](assets/stripe-checkout-policy-highlight.png)
...
![Collect terms of service agreement](assets/stripe-checkout-tos-consent.png)
...
- Cancellation mechanisms and policies
  ![Default payment method reuse agreement display in subscription mode](assets/stripe-checkout-payment-method-reuse-agreement.png)
