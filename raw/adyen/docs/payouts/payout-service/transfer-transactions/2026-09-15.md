<!-- Source URL: https://docs.adyen.com/payouts/payout-service/transfer-transactions.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Track transactions"
description: "Use our API to get updates about transactions resulting from payouts."
url: "https://docs.adyen.com/payouts/payout-service/transfer-transactions"
source_url: "https://docs.adyen.com/payouts/payout-service/transfer-transactions.md"
canonical: "https://docs.adyen.com/payouts/payout-service/transfer-transactions"
...
These transactions result from paying out funds to third-party [bank account](/payouts/payout-service/pay-out-to-bank-accounts) or [card](/payouts/payout-service/pay-out-to-cards). The following shows an example response that you would get for an outgoing external transactions.
...
These transactions result from [internal transfers](/payouts/payout-service/internal-fund-transfers) between balance accounts. The following tabs show example responses that you would get when making a request to get incoming or outgoing internal transactions.
