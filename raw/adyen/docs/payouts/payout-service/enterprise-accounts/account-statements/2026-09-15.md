<!-- Source URL: https://docs.adyen.com/payouts/payout-service/enterprise-accounts/account-statements.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
Account statements summarize the financial activity in your enterprise account for a specific period, such as a day or a month. You can use these auditable statements to reconcile balances and provide detailed transaction reports to your users. If your balance account is linked to an [Adyen-issued card](/issuing), transactions processed with that card also appear in the statement.
