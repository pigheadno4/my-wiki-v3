<!-- Source URL: https://docs.adyen.com/issuing/test-verification-errors.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/issuing/test-verification-errors"
source_url: "https://docs.adyen.com/issuing/test-verification-errors.md"
canonical: "https://docs.adyen.com/issuing/test-verification-errors"
...
When [verifying users](/issuing/verification-overview), the verification checks performed by Adyen can return a range of [error messages](/issuing/kyc-verification-codes).
...
This allows you to reproduce an unsuccessful verification flow, including the result and corresponding [verification codes](/issuing/kyc-verification-codes). You can then also test the remediating flow to resolve the verification errors.
...
Use a [suberror code](/issuing/kyc-verification-codes/sub-errors) as your requested verification code. You can include one code at a time in your request header. Requested verification codes can only be used in your test environment.
...
For error tests for legal entities, you need to [create an account holder](/issuing/onboard-users) for the legal entity of the organization, individual, or sole proprietorship.

For error tests for documents or transfer instruments, you need to [create an account holder](/issuing/onboard-users) for the legal entity who owns the resource.
...
* [List of verification suberror codes](/issuing/kyc-verification-codes/sub-errors)
