<!-- Source URL: https://docs.adyen.com/issuing/manage-access/api-credentials-web-service.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/issuing/manage-access/api-credentials-web-service"
source_url: "https://docs.adyen.com/issuing/manage-access/api-credentials-web-service.md"
canonical: "https://docs.adyen.com/issuing/manage-access/api-credentials-web-service"
...
| ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| **Integration type**                           | An [Adyen for Platforms](/adyen-for-platforms-model) integration.                                                          |
| **[Customer Area roles](/account/user-roles)** | Make sure that your user account has the following [role](/account/user-roles#platforms):- **Balance platform admin role** |
...
| --------------------------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Web service**             | `ws[_123456]@BalancePlatform.[YourBalancePlatform]` | • [Configuration API](https://docs.adyen.com/api-explorer/balanceplatform/latest/overview): Manage account holders and balance accounts. • [Transfers API](https://docs.adyen.com/api-explorer/transfers/latest/overview): Process transfers and Adyen-issued card payments. • [Session authentication API](https://docs.adyen.com/api-explorer/sessionauthentication/latest/overview): Create session tokens for Platform Experience components. • [Capital API](https://docs.adyen.com/api-explorer/capital/latest/overview): Offer business financing (additional configuration required). |
| **Legal entity management** | `ws[_123456]@Scope.Company_[YourCompanyAccount]`    | • [Legal Entity Management API](https://docs.adyen.com/api-explorer/legalentity/latest/overview): Onboard and manage legal entities and [verification information](/platforms/onboard-users/onboarding-steps). • [Session authentication API](https://docs.adyen.com/api-explorer/sessionauthentication/latest/overview): Create session tokens for Onboarding components.                                                                                                                                                                                                                    |
...
To create an API credential for a LEM user:
...
5. In the **Create API credential** dialog, under **Credential type**, select **LEM user**.
...
Use [API keys to authenticate your requests](/development-resources/api-authentication#api-key-authentication). Every web service and LEM user has its own API key.
...
* [Manage access for your team](/issuing/manage-access)
* [Roles for API credentials](/issuing/manage-access/webservice-roles)
