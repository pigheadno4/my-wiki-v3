<!-- Source URL: https://docs.adyen.com/marketplaces/split-transactions/split-payments-at-authorization.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Split payments at authorization"
description: "Learn how to split a transaction at the time of payment."
url: "https://docs.adyen.com/marketplaces/split-transactions/split-payments-at-authorization"
source_url: "https://docs.adyen.com/marketplaces/split-transactions/split-payments-at-authorization.md"
canonical: "https://docs.adyen.com/marketplaces/split-transactions/split-payments-at-authorization"
...
1. Add a `splits` array to your POST [/payments](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#request-splits) or POST [/sessions](https://docs.adyen.com/api-explorer/Checkout/latest/post/sessions#request-splits) request.
   ...
   | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | - |
   | `account`         | ![Required](/user/pages/reuse/image-library/01.icons/required/required.svg?decoding=auto\&fetchpriority=auto)                                           | The account that will receive (or be charged) the split amount. This is the `balanceAccountId` of one of your user's balance accounts or your marketplace's liable balance account. You do not need to specify this field when `type` is **Commission**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |   |
   ...
   - **Remainder**: books the amount left over after a [currency conversion](/marketplaces/currency-conversion) to the specified balance account. By default, the amount is booked to your marketplace's liable balance account.
   - We recommend that you also include at least one [transaction fee type ](/marketplaces/transaction-fees)in your request. All undefined transaction fees are booked to your marketplace's liable balance account.
   ...
   * With `type` **Commission**, we book USD 5.00 to your liable balance account as your marketplace's commission.
