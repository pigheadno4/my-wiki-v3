<!-- Source URL: https://docs.adyen.com/marketplaces/currency-conversion/refunds.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/marketplaces/currency-conversion/refunds"
source_url: "https://docs.adyen.com/marketplaces/currency-conversion/refunds.md"
canonical: "https://docs.adyen.com/marketplaces/currency-conversion/refunds"
...
In your refund request, you can define how you want to book the remainder amount by adding a split item with `type` **Remainder**. You can book this amount either to your **user** or your own **marketplace**. If you do not specify how to handle the remainder in your request, it is booked to your liable balance account.

We recommend that you always provide the **Remainder** split item in your requests, because it can help you reconcile the remainder per transaction using the [Balance Platform Accounting Report](/marketplaces/reports-and-fees/balance-platform-accounting-report).

## Next steps

Choose whether to book the remainder to your user or your marketplace.

[Your user](/marketplaces/currency-conversion/refunds/your-user)

[Book the leftover amount after currency conversion (the remainder) to your user.](/marketplaces/currency-conversion/refunds/your-user)

[Your marketplace](/marketplaces/currency-conversion/refunds/your-platform)

[Book the leftover amount after currency conversion (the remainder) to the customer.](/marketplaces/currency-conversion/refunds/your-platform)
