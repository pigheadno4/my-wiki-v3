<!-- Source URL: https://docs.adyen.com/marketplaces/test-verification-errors.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/marketplaces/test-verification-errors"
source_url: "https://docs.adyen.com/marketplaces/test-verification-errors.md"
canonical: "https://docs.adyen.com/marketplaces/test-verification-errors"
...
When [verifying users](/marketplaces/verification-overview), the verification checks performed by Adyen can return a range of [error messages](/marketplaces/kyc-verification-codes).
...
This allows you to reproduce an unsuccessful verification flow, including the result and corresponding [verification codes](/marketplaces/kyc-verification-codes). You can then also test the remediating flow to resolve the verification errors.
...
| **[API credentials](/development-resources/api-credentials/)** | You must have a API credential for [legal entity management](/marketplaces/manage-access/api-credentials-web-service). To check verification errors by making API requests, you must have a [API web service user credential](/marketplaces/manage-access/api-credentials-web-service) for the [Configuration API](https://docs.adyen.com/api-explorer/balanceplatform/latest/overview).. |
...
Use a [suberror code](/marketplaces/kyc-verification-codes/sub-errors) as your requested verification code. You can include one code at a time in your request header. Requested verification codes can only be used in your test environment.
...
For error tests for legal entities, you need to [create an account holder](/marketplaces/onboard-users) for the legal entity of the organization, individual, or sole proprietorship.

For error tests for documents or transfer instruments, you need to [create an account holder](/marketplaces/onboard-users) for the legal entity who owns the resource.
