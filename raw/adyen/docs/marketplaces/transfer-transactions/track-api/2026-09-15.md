<!-- Source URL: https://docs.adyen.com/marketplaces/transfer-transactions/track-api.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Track transactions with API requests"
description: "Use the Transfers API to query transactions in your marketplace."
url: "https://docs.adyen.com/marketplaces/transfer-transactions/track-api"
source_url: "https://docs.adyen.com/marketplaces/transfer-transactions/track-api.md"
canonical: "https://docs.adyen.com/marketplaces/transfer-transactions/track-api"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Track transactions with API requests

Use the Transfers API to query transactions in your marketplace.
...
* A [payment](/marketplaces/process-payments) from a purchase in your platform results in an incoming external transaction.
* A [payout](/marketplaces/managed-payouts) to one of your users results in an outgoing external transaction.
...
These transactions result from [internal transfers](/marketplaces/internal-fund-transfers) between balance accounts. The following tabs show example responses that you would get when making a request to get incoming or outgoing internal transactions.
...
These fields indicate when the funds are recorded and when they are deducted from your balance account. For example, when you pay out to a transfer instrument after bank cutoff times, the funds are reserved but are not yet deducted. In this scenario, the dates will be:
...
* [Track transactions with webhooks](/marketplaces/transfer-transactions/track-webhooks)
