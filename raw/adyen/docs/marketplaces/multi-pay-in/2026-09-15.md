<!-- Source URL: https://docs.adyen.com/marketplaces/multi-pay-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/marketplaces/multi-pay-in"
source_url: "https://docs.adyen.com/marketplaces/multi-pay-in.md"
canonical: "https://docs.adyen.com/marketplaces/multi-pay-in"
...
| **[Capabilities](/marketplaces/verification-overview/capabilities)** | Make sure that your account holders have the following capabilities:- **sendToBalanceAccount**
...
For more information on multi pay-in accounts, see [Receive funds from a third party](/marketplaces/multi-pay-in/receive-funds).
...
For more information on how to transfer and allocate payments from your multi pay-in account to balance accounts, see [Allocate third-party payments](/marketplaces/multi-pay-in/payments).
...
For more information on how to refund payments processed through your pay-in partner, see [Refund third-party payments](/marketplaces/multi-pay-in/refunds).

## Next steps

[required](/marketplaces/multi-pay-in/receive-funds)

[Receive funds](/marketplaces/multi-pay-in/receive-funds)

[Learn about how funds settle in your multi pay-in accounts.](/marketplaces/multi-pay-in/receive-funds)
...
[Learn how to transfer and allocate funds using multi pay-in.](/marketplaces/multi-pay-in/payments)

[Refund third-party payments](/marketplaces/multi-pay-in/refunds)

[Learn how to refund payments processed through a pay-in partner.](/marketplaces/multi-pay-in/refunds)
