<!-- Source URL: https://docs.adyen.com/marketplaces/verification-requirements.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/marketplaces/verification-requirements"
source_url: "https://docs.adyen.com/marketplaces/verification-requirements.md"
canonical: "https://docs.adyen.com/marketplaces/verification-requirements"
...
To start the verification process, you must collect and submit the [required verification information](/marketplaces/onboard-users/onboarding-steps) from your user. These requirements depend on:
...
See [minimum required information](/marketplaces/verification-requirements/required-kyc-information) for more details on the requirements for specific countries/regions and legal entities.
...
Organizations with UBOs, signatories, and directors that reside outside the current [supported countries and regions](/marketplaces/#supported-countries-regions) may require additional due diligence. Reach out to your Adyen contact to confirm if these individuals can be accepted. Some individuals may exceed Adyen's risk tolerance and therefore cannot be accepted.
...
The entity is an individual who is a citizen of one of the [supported countries/regions](/marketplaces#supported-countries-regions).
...
* Bank account
* Job title, if the individual is a [UBO through control](/marketplaces/verification-requirements?tab=organization_1#identify-ubos) or a [signatory](/marketplaces/verification-requirements?tab=organization_1#identify-ubos) for an organization

### Tab: Sole proprietorship

The individual who holds a contractual relationship with your marketplace is a sole proprietor. A sole proprietor exclusively owns a business, and their business is registered in the country/region they are operating in.
...
* Full names of the settlors, trustees, protectors, beneficiaries, and ultimate beneficial owners for the trust. If the settlor has an exemption reason, you must provide it when you [associate them to the trust](/marketplaces/onboard-users).
...
Adyen supports the onboarding of both unincorporated and incorporated partnerships. This page outlines the requirements for **unincorporated partnerships**. For information on onboarding incorporated partnerships, please refer to the section about [organizations](/marketplaces/verification-requirements?tab=organization_0_1).
...
Each financial product includes specific [capabilities](/marketplaces/verification-overview/capabilities) that are available for your users. Different financial products might have overlapping capabilities. For some financial products, such as card issuing, capabilities might also have different levels.
...
In addition to the [minimum required information](/marketplaces/verification-requirements/required-kyc-information) based on the country/region and legal entity type, you must also collect the following:

* [Industry](/marketplaces/verification-requirements/reference-additional-products/#list-industry-codes) in which the user is registered based on their local chamber of commerce
* URL of the user's website if they have an online presence
* The user's [source of funds](/marketplaces/verification-requirements/reference-additional-products#list-source-of-funds)
* For organizations, their [Foreign Account Tax Compliance Act (FATCA)/Common Reporting Standard (CRS) classification](/marketplaces/verification-requirements/reference-additional-products#list-fatca-crs), which includes their business type and their main source of income.
* Tax residence country and [ID number](/marketplaces/verification-requirements/data-formats-per-country). This is required for both organizations and the individuals associated with the organization, or the sole proprietorship owner.
