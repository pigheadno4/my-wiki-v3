<!-- Source URL: https://docs.adyen.com/marketplaces/verification-requirements/document-requirements.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/marketplaces/verification-requirements/document-requirements"
source_url: "https://docs.adyen.com/marketplaces/verification-requirements/document-requirements.md"
canonical: "https://docs.adyen.com/marketplaces/verification-requirements/document-requirements"
...
Only applicable when creating [business accounts](/marketplaces/verification-requirements?tab=business-accounts_1) using [onboarding v4](/marketplaces/onboard-users/onboarding-versions/onboarding-v4).
...
Only applicable starting from [onboarding v4](/marketplaces/onboard-users/onboarding-versions/onboarding-v4#id-validation).
...
* For some countries/regions, the VAT number is not the same as the tax ID number. Please check [local names for tax ID numbers](/marketplaces/verification-requirements/data-formats-per-country/).
...
If the automatic verification of your user's [source of funds](/marketplaces/verification-requirements/reference-additional-products#list-source-of-funds) fails, Adyen may ask for proof of their source of funds. This information must identify the main source of the funds or assets that are deposited to an [Adyen business account](/business-accounts) or used to fund an [Adyen-issued card](/issuing/create-cards).
...
* The “doing business as” / “trading as” name cannot be accepted as the legal name of your company. Please make sure to fill in the correct legal entity name.
* For some countries/regions, the VAT number is not the same as the tax ID number. Please check [local names for VAT numbers](/marketplaces/verification-requirements/data-formats-per-country/).
