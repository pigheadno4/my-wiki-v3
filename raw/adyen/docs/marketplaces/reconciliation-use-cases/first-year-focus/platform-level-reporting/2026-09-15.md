<!-- Source URL: https://docs.adyen.com/marketplaces/reconciliation-use-cases/first-year-focus/platform-level-reporting.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Marketplace-level reporting"
description: "An overview of the key reporting use cases to prioritize for your business."
url: "https://docs.adyen.com/marketplaces/reconciliation-use-cases/first-year-focus/platform-level-reporting"
source_url: "https://docs.adyen.com/marketplaces/reconciliation-use-cases/first-year-focus/platform-level-reporting.md"
canonical: "https://docs.adyen.com/marketplaces/reconciliation-use-cases/first-year-focus/platform-level-reporting"
...
The following use-cases for marketplace reporting are designed to help your marketplace's product and finance teams view accounting reports for common reconciliation purposes.
...
| [Identify profitability of a marketplace user by reconciling total collected commission with total fees incurred for that user](#user-level-profitability) | User-level profitability        |
...
Alternatively, the [Balance Platform Accounting Report](/marketplaces/reports-and-fees/balance-platform-accounting-report) contains all events that impacted monthly profitability when filtered on the Liable Account and filtering the value date to the period that is being reconciled.
...
**Job to be done: Identify profitability of a marketplace user by reconciling total collected commission with total fees incurred for that user**\
As a marketplace that offers embedded payments, you want to understand the profitability of serving each of your users. You want to understand how much of a profit you are making on different users to optimize your pricing model accordingly.
...
Your main invoice will be the [Payment Processing Invoice](/reporting/invoice-reconciliation/payment-processing-invoice/). This invoice includes the costs related to all transactions processed on your marketplace over the course of the invoice period.
...
You can read more about balance platform fees in [reports and fee types](/marketplaces/reports-and-fees/).
