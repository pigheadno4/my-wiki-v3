<!-- Source URL: https://docs.adyen.com/payment-methods/bacs/ios-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "BACS Direct Debit iOS Component"
description: "Add BACS Direct Debit to your Components integration."
url: "https://docs.adyen.com/payment-methods/bacs/ios-component"
source_url: "https://docs.adyen.com/payment-methods/bacs/ios-component.md"
canonical: "https://docs.adyen.com/payment-methods/bacs/ios-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# BACS Direct Debit iOS Component
...
To [initialize](#initialize-the-component) BACS Direct Debit, use the `BACSDirectDebitComponent` class.
...
// Create an instance of BACSDirectDebitComponent.
let component = BACSDirectDebitComponent(paymentMethod: paymentMethod,
                                        context: context,
                                        // Set the configuration object that you created for BACS Direct Debit.
...
| **Action handling**  | Make sure that your existing integration is set up to [handle the additional action](/online-payments/build-your-integration/advanced-flow/?platform=iOS\&integration=Components#handle-the-redirect). `action.type`: **Direct**. |   |
| **Setup steps**      | Before you begin, [add BACS Direct Debit in your Customer Area](/payment-methods/add-payment-methods).                                                                                                                            |   |
