<!-- Source URL: https://docs.adyen.com/payment-methods/gcash/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "GCash Android Component"
description: "Add GCash to your Components integration."
url: "https://docs.adyen.com/payment-methods/gcash/android-component"
source_url: "https://docs.adyen.com/payment-methods/gcash/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/gcash/android-component"
last_modified: "2026-09-15T14:06:03+02:00"
language: "en"
---

# GCash Android Component
...
## Import the Component for GCash

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for GCash.
...
## Launch and show the Component for GCash

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for GCash, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("gcash")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for GCash.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for GCash, use the `InstantPaymentComponent` class.
