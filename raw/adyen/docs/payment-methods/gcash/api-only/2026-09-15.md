<!-- Source URL: https://docs.adyen.com/payment-methods/gcash/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "GCash for API only"
description: "Add GCash to your API-only integration."
url: "https://docs.adyen.com/payment-methods/gcash/api-only"
source_url: "https://docs.adyen.com/payment-methods/gcash/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/gcash/api-only"
...
Add GCash to your API-only integration.
...
1. The shopper selects GCash as the payment method.
...
Include GCash in the list of available payment methods. You do not need to collect any information from the shopper in your payment form.

You can [download the logo for GCash](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%2Bonly\&version=71#downloading-logos) to use in your form.

## Get GCash as an available payment method

When you make the [/paymentMethods](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) to [get available payment methods](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%20only#get-available-payment-methods), specify the following so that GCash is included in the response.

| Parameter                                                                                                          | Values                                                |
| ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- |
| [countryCode](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-countryCode)         | ****PH****                                            |
| [amount.currency](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-amount-currency) | ****PHP****                                           |
...
| [channel](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-channel)                 | Specify for example **Web**, **iOS**, or **Android**. |
...
**Example response with GCash available**
