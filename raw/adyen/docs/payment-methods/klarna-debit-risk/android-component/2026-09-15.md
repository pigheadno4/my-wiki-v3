<!-- Source URL: https://docs.adyen.com/payment-methods/klarna-debit-risk/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Klarna Debit Risk Android Component"
description: "Add Klarna Debit Risk to your Components integration."
url: "https://docs.adyen.com/payment-methods/klarna-debit-risk/android-component"
source_url: "https://docs.adyen.com/payment-methods/klarna-debit-risk/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/klarna-debit-risk/android-component"
last_modified: "2026-09-15T14:06:03+02:00"
language: "en"
---

# Klarna Debit Risk Android Component
...
You do not need to add any additional parameters when you [create a payment session](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#create-a-payment-session).

### Import-Component

## Import the Component for Klarna Debit Risk

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Klarna Debit Risk.
...
## Launch and show the Component for Klarna Debit Risk

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Klarna Debit Risk, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("directEbanking")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Klarna Debit Risk.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Klarna Debit Risk, use the `InstantPaymentComponent` class.
...
You do not need to add any additional parameters to the [/payments](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments) request when you [make a payment](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#make-a-payment).
