<!-- Source URL: https://docs.adyen.com/payment-methods/klarna-debit-risk/ios-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Klarna Debit Risk iOS Component"
description: "Add Klarna Debit Risk to your Components integration."
url: "https://docs.adyen.com/payment-methods/klarna-debit-risk/ios-component"
source_url: "https://docs.adyen.com/payment-methods/klarna-debit-risk/ios-component.md"
canonical: "https://docs.adyen.com/payment-methods/klarna-debit-risk/ios-component"
last_modified: "2026-09-15T14:06:03+02:00"
language: "en"
---

# Klarna Debit Risk iOS Component
...
You do not need to add any additional parameters when you [create a payment session](/online-payments/build-your-integration/sessions-flow?platform=iOS\&integration=Components#create-a-payment-session).
...
To [initialize](#initialize-the-component) Klarna Debit Risk, use the `None` class.
...
let component = None(paymentMethod: paymentMethod,
                                        context: context,
                                        // Set the configuration object that you created for Klarna Debit Risk.
                                        configuration: directEbankingConfiguration)
...
You do not need to add any additional parameters to the [/payments](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments) request when you [make a payment](/online-payments/build-your-integration/advanced-flow/?platform=iOS\&integration=Components#make-a-payment).
