<!-- Source URL: https://docs.adyen.com/payment-methods/online-banking-poland/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Online banking Poland Android Component"
description: "Add Online banking Poland to your Components integration."
url: "https://docs.adyen.com/payment-methods/online-banking-poland/android-component"
source_url: "https://docs.adyen.com/payment-methods/online-banking-poland/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/online-banking-poland/android-component"
last_modified: "2026-09-15T14:06:04+02:00"
language: "en"
---

# Online banking Poland Android Component
...
## Import the Component for Online banking Poland

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Online banking Poland.
...
```java
implementation "com.adyen.checkout:onlinebankingpl:YOUR_VERSION"
...
## Launch and show the Component for Online banking Poland

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Online banking Poland, use the `OnlineBankingPLComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod(PaymentMethodTypes.ONLINE_BANKING_PL)

@Composable
private fun ComposableOnlineBankingPLComponent() {
  // Keep a reference to this Component in case you need to access it later.
  val onlinebankingplComponent = OnlineBankingPLComponent.PROVIDER.get(
  ...
  AdyenComponent(
     component = onlinebankingplComponent,
...
binding.onlinebankingplView.attach(onlinebankingplComponent, activity) // Your activity or fragment.
```
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Online banking Poland.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Online banking Poland, use the `OnlineBankingPLComponent` class.
...
val paymentMethod = paymentMethodsApiResponse?.paymentMethods.orEmpty().firstOrNull {
  it.type == PaymentMethodTypes.ONLINE_BANKING_PL
}
