<!-- Source URL: https://docs.adyen.com/payment-methods/online-banking-czech-republic/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Online banking Czech Republic Android Component"
description: "Add Online banking Czech Republic to your Components integration."
url: "https://docs.adyen.com/payment-methods/online-banking-czech-republic/android-component"
source_url: "https://docs.adyen.com/payment-methods/online-banking-czech-republic/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/online-banking-czech-republic/android-component"
last_modified: "2026-09-15T14:06:04+02:00"
language: "en"
---

# Online banking Czech Republic Android Component
...
## Import the Component for Online banking Czech Republic

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Online banking Czech Republic.
...
```java
implementation "com.adyen.checkout:onlineBankingCZ:YOUR_VERSION"
...
## Launch and show the Component for Online banking Czech Republic

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Online banking Czech Republic, use the `OnlineBankingCZComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod(PaymentMethodTypes.ONLINE_BANKING_CZ)

@Composable
private fun ComposableOnlineBankingCZComponent() {
  // Keep a reference to this Component in case you need to access it later.
  val onlineBankingCZComponent = OnlineBankingCZComponent.PROVIDER.get(
  ...
  AdyenComponent(
     component = onlineBankingCZComponent,
...
binding.onlineBankingCZView.attach(onlineBankingCZComponent, activity) // Your activity or fragment.
```
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Online banking Czech Republic.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Online banking Czech Republic, use the `OnlineBankingCZComponent` class.
...
val paymentMethod = paymentMethodsApiResponse?.paymentMethods.orEmpty().firstOrNull {
  it.type == PaymentMethodTypes.ONLINE_BANKING_CZ
}
