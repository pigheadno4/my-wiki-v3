<!-- Source URL: https://docs.adyen.com/payment-methods/cards/react-native-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/payment-methods/cards/react-native-component"
source_url: "https://docs.adyen.com/payment-methods/cards/react-native-component.md"
canonical: "https://docs.adyen.com/payment-methods/cards/react-native-component"
...
| -------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **Integration type** | Make sure that you have built your [React Native Components integration](/online-payments/build-your-integration). |
...
You can optionally include the following properties when you [configure `AdyenCheckout`](/online-payments//build-your-integration/advanced-flow?platform=React%20Native\&integration=Components\&version=latest#configure):
...
Co-badged cards are rendered by Component according to the [co-badged card regulations for the applicable regions](/online-payments/co-badged-cards-compliance/). This means that Components renders all supported brands, and allows the cardholder to choose their preferred brand.
...
* [Components integration guide](/online-payments//build-your-integration/advanced-flow?platform=React%20Native\&integration=Components\&version=latest)
