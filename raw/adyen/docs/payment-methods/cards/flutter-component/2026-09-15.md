<!-- Source URL: https://docs.adyen.com/payment-methods/cards/flutter-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/payment-methods/cards/flutter-component"
source_url: "https://docs.adyen.com/payment-methods/cards/flutter-component.md"
canonical: "https://docs.adyen.com/payment-methods/cards/flutter-component"
...
When you [make the `/sessions` request](/online-payments/build-your-integration/sessions-flow?platform=Flutter\&integration=Components#create-a-payment-session), cards does not require any additional fields.

### Tab: Advanced flow

When you [make the `/payments` request](/online-payments/build-your-integration/advanced-flow?platform=Flutter\&integration=Components#make-a-payment), cards does not require any additional fields.

## Components configuration

### Tab: Sessions flow

When you [configure](/online-payments/build-your-integration/sessions-flow?platform=Flutter\&integration=Components#configure) the Component, cards does not require any additional configuration.

### Tab: Advanced flow

When you [configure](/online-payments/build-your-integration/advanced-flow?platform=Flutter\&integration=Components#configure) the Component, cards does not require any additional configuration.
...
After adding the configuration object for cards, [initialize and show](/online-payments/build-your-integration/sessions-flow?platform=Flutter\&integration=Components#launch-and-show) the Component.

### Tab: Advanced flow

After adding the configuration object for cards, [add the required callbacks](/online-payments/build-your-integration/advanced-flow?platform=Flutter\&integration=Components#launch-and-show).
...
* [In your Components configuration](#configuration), make sure that `showStorePaymentField` is set to **true**. This shows a switch for your shopper to choose to store their card details.
...
3. When [you launch and show the Component](/online-payments/build-your-integration/advanced-flow?platform=Flutter\&integration=Components#show), use the stored payment methods.

The Component shows the stored payment method in the payment form.
