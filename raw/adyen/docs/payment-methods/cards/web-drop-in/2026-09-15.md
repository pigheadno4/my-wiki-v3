<!-- Source URL: https://docs.adyen.com/payment-methods/cards/web-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/payment-methods/cards/web-drop-in"
source_url: "https://docs.adyen.com/payment-methods/cards/web-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/cards/web-drop-in"
last_modified: "2023-05-26T11:02:00+02:00"
language: "en"
---
...
Include the `cardConfiguration` object when [creating a configuration object for Drop-in](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Drop-in#create-instance):
...
To split debit and credit cards in your payment form, include in your POST `/sessions` request [splitCardFundingSources](https://docs.adyen.com/api-explorer/Checkout/latest/post/sessions#request-splitCardFundingSources): **true**.

### Tab: Advanced flow

If you implemented an [additional use case](/online-payments/build-your-integration).

To split debit and credit cards in your payment form, include in your POST [/paymentMethods](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) request [splitCardFundingSources](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-splitCardFundingSources): **true**.
...
* Make sure that `enableStoreDetails` is set to **true** in the [optional configuration for Drop-in](#optional-configuration). This shows a checkbox for your shopper to choose to store their card details.
