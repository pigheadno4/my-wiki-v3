<!-- Source URL: https://docs.adyen.com/payment-methods/cards/android-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/payment-methods/cards/android-drop-in"
source_url: "https://docs.adyen.com/payment-methods/cards/android-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/cards/android-drop-in"
...
This page is for **v5.0.0**, released in October 2023. If you are using an earlier version, use [the guide for earlier versions](/payment-methods/cards/android-drop-in/earlier-versions) instead.
...
When you [make the `/sessions` request](/online-payments//build-your-integration/sessions-flow?platform=Android\&integration=Drop-in#create-a-payment-session), cards does not require any additional fields.

### Tab: Advanced flow

When you [make the `/payments` request](/online-payments/build-your-integration/advanced-flow?platform=Android\&integration=Drop-in#make-a-payment), cards does not require any additional fields.

## Drop-in Configuration

### Tab: Sessions flow

When you [configure](/online-payments//build-your-integration/sessions-flow?platform=Android\&integration=Drop-in#configure) Drop-in, cards does not require any additional configuration.

### Tab: Advanced flow

When you [configure](/online-payments/build-your-integration/advanced-flow?platform=Android\&integration=Drop-in#configure) Drop-in, cards does not require any additional configuration.
...
1. In your [`DropInService` ](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Drop-in\&version=5.7.0#configure), implement the `onAddressLookupQueryChanged(query: String)` callback to make an API request to the address lookup API you use with the `query` parameter.
...
3. Pass the lookup result to Drop-in using the `AddressLookupDropInServiceResult` class.\
   For example:
   ...
   **Your DropInService**
   ...
   class YourDropInService : DropInService() {
       // Implement the callback to suggest addresses to your shopper.
...
Your client side shows the list of suggested addresses to the shopper. Then, implement the `onAddressLookupCompletion(lookupAddress: LookupAddress)` callback.
...
3. Pass the lookup result to Drop-in with the`sendAdressLookupResult` function, and the `AddressLookupDropInServiceResult` class.
   ...
   **Implement the address selected callback**
   ...
   class YourDropInService : DropInService() {
       ...
       // Implement the callback to get the full details for the LookupAddress your shopper selects.
       ...
       // Your other DropInService handlers.
   }
   ```
...
* Make sure that your [Drop-in configuration](#drop-inconfiguration) includes `setShowStorePaymentField(true)` to show a switch for storing card details.
