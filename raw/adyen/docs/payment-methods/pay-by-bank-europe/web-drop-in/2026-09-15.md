<!-- Source URL: https://docs.adyen.com/payment-methods/pay-by-bank-europe/web-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Pay by Bank (Europe) Drop-in integration"
description: "Add Pay by Bank (Europe) to an existing Drop-in integration."
url: "https://docs.adyen.com/payment-methods/pay-by-bank-europe/web-drop-in"
source_url: "https://docs.adyen.com/payment-methods/pay-by-bank-europe/web-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/pay-by-bank-europe/web-drop-in"
...
Include the `openBankingConfiguration` object when [creating a configuration object for Drop-in](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Drop-in#create-instance):
...
const dropin = new Dropin(checkout, dropinConfiguration).mount(#openBanking-container)
```
