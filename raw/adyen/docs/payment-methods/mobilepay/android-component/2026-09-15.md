<!-- Source URL: https://docs.adyen.com/payment-methods/mobilepay/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "MobilePay Android Component"
description: "Add MobilePay to your Components integration."
url: "https://docs.adyen.com/payment-methods/mobilepay/android-component"
source_url: "https://docs.adyen.com/payment-methods/mobilepay/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/mobilepay/android-component"
last_modified: "2026-09-15T14:06:04+02:00"
language: "en"
---

# MobilePay Android Component
...
## Import the Component for MobilePay

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for MobilePay.
...
## Launch and show the Component for MobilePay

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for MobilePay, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("mobilepay")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for MobilePay.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for MobilePay, use the `InstantPaymentComponent` class.
