<!-- Source URL: https://docs.adyen.com/payment-methods/paypal/android-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayPal Drop-in integration"
description: "Add PayPal to an existing Android Drop-in integration."
url: "https://docs.adyen.com/payment-methods/paypal/android-drop-in"
source_url: "https://docs.adyen.com/payment-methods/paypal/android-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/paypal/android-drop-in"
last_modified: "2021-07-26T11:31:00+02:00"
language: "en"
---
...
Our [Android Drop-in](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Drop-in) renders PayPal in your payment form, and redirects the shopper to complete the payment. As with other redirect payment methods, you need to [check the payment result](#check-the-payment-result) after the shopper returns to your app.

## Requirements

| Requirement          | Description                                                                                                 |
| -------------------- | ----------------------------------------------------------------------------------------------------------- |
| **Integration type** | Make sure that you have built your [Drop-in integration](/online-payments//).                               |
...
To show PayPal in your payment form, specify in your [/paymentMethods](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) request:
...
1. From your server, make a POST [/payments](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments) request, specifying:
   ...
   | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | `paymentMethod`                                                                                  | ![-white\_check\_mark-](/user/data/smileys/emoji/white_check_mark.png "-white_check_mark-") | The `paymentComponentData.paymentMethod` from your client app.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
