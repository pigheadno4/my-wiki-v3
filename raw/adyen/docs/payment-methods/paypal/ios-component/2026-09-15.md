<!-- Source URL: https://docs.adyen.com/payment-methods/paypal/ios-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayPal Redirect Component"
description: "Add PayPal to an existing iOS Components integration."
url: "https://docs.adyen.com/payment-methods/paypal/ios-component"
source_url: "https://docs.adyen.com/payment-methods/paypal/ios-component.md"
canonical: "https://docs.adyen.com/payment-methods/paypal/ios-component"
...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Integration type** | Make sure that you have built your [Components integration](/online-payments/build-your-integration/sessions-flow?platform=iOS\&integration=Components%2F%3Ftarget%3D_blank). |
...
guard let paymentMethod = paymentMethods.paymentMethod(ofType: .other("paypal")) else { return }
...
```swift
// Check that the payment method is supported before showing the Component.
guard let paymentMethod = paymentMethods.paymentMethod(ofType: PayPalPaymentMethod.self) else { return }
let style = FormComponentStyle()
let component = PayPalComponent(paymentMethod: paymentMethod,
                                apiContext: context,
                                style: style)
present(component)
```
