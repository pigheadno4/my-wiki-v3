<!-- Source URL: https://docs.adyen.com/payment-methods/atome/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Atome Android Component"
description: "Add Atome to your Components integration."
url: "https://docs.adyen.com/payment-methods/atome/android-component"
source_url: "https://docs.adyen.com/payment-methods/atome/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/atome/android-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Atome Android Component
...
To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Atome.
...
To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Atome, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("atome")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Atome.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Atome, use the `InstantPaymentComponent` class.
