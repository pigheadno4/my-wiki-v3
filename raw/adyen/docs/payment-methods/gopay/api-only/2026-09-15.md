<!-- Source URL: https://docs.adyen.com/payment-methods/gopay/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "GoPay for API only"
description: "Add GoPay to your API-only integration."
url: "https://docs.adyen.com/payment-methods/gopay/api-only"
source_url: "https://docs.adyen.com/payment-methods/gopay/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/gopay/api-only"
...
2. The shopper enters their details in the [payment form that you build](#build-your-payment-form), if applicable.
...
You can [download the logo for GoPay](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%2Bonly\&version=71#downloading-logos) to use in your form.

## Get GoPay as an available payment method

When you make the [/paymentMethods](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) to [get available payment methods](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%20only#get-available-payment-methods), specify the following so that GoPay is included in the response.

| Parameter                                                                                                          | Values                                                                              |
| ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------- |
| [countryCode](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-countryCode)         | **ID**                                                                              |
| [amount.currency](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-amount-currency) | **IDR**                                                                             |
...
**Example response with GoPay available**
