<!-- Source URL: https://docs.adyen.com/payment-methods/affirm/ios-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Affirm Drop-in integration"
description: "Add Affirm to an existing iOS Drop-in integration."
url: "https://docs.adyen.com/payment-methods/affirm/ios-drop-in"
source_url: "https://docs.adyen.com/payment-methods/affirm/ios-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/affirm/ios-drop-in"
...
Add Affirm to an existing iOS Drop-in integration.

This page explains how to add Affirm to your existing iOS Drop-in integration.
...
When you [configure Drop-in](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Drop-in#id1031863926), you can add optional configuration for Affirm.
...
Include the `affirmConfiguration` object when [creating a configuration object for Drop-in](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Drop-in#create-instance):
...
const dropin = new Dropin(checkout, dropinConfiguration).mount(#affirm-container)
```
