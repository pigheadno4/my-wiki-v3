<!-- Source URL: https://docs.adyen.com/payment-methods/zip/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Zip for API only"
description: "Add Zip to an existing API-only integration."
url: "https://docs.adyen.com/payment-methods/zip/api-only"
source_url: "https://docs.adyen.com/payment-methods/zip/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/zip/api-only"
...
| **Setup steps**      | Before you begin, [add Zip in your test Customer Area](/payment-methods/add-payment-methods).                                                        |
...
| Delivery address              | The postal address where the goods will be delivered. Required only when the shopper prefers that the goods are delivered to them. |
...
* [countryCode](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-countryCode): The two-letter [ISO country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) (**AU** or **US**).
* [amount.currency](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-amount-currency): The three-character [ISO currency code](/development-resources/currency-codes#currency-codes?target=_blank) (**AUD** or **USD**).
* [amount.value](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-amount-value): The amount of the payment, in [minor units](/development-resources/currency-codes#minor-units?target=_blank).
...
This is the default with [API-only v5.0.0](/online-payments/) or later.
