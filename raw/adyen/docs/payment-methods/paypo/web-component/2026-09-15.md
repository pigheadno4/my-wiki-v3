<!-- Source URL: https://docs.adyen.com/payment-methods/paypo/web-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayPo Web Component"
description: "Add PayPo to your Components integration."
url: "https://docs.adyen.com/payment-methods/paypo/web-component"
source_url: "https://docs.adyen.com/payment-methods/paypo/web-component.md"
canonical: "https://docs.adyen.com/payment-methods/paypo/web-component"
...
## Initialize the Component for PayPo

To [initialize](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Components#initialize-the-payment-session) PayPo, use the `Redirect` class.

**Initialize the Component**

```javascript
const redirectComponent = new Redirect(checkout, { type:paypo }).mount('#redirect-container')
```
...
| **Action handling**  | Make sure that your existing integration is set up to [handle the additional action](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=Components#handle-the-redirect). `action.type`: ****redirect****. |   |
| **Setup steps**      | Before you begin, [add PayPo in your Customer Area](/payment-methods/add-payment-methods).                                                                                                                                              |   |
...
To [initialize](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=Components#initialize-the-payment-session) PayPo, use the `Redirect` class.
