<!-- Source URL: https://docs.adyen.com/payment-methods/paypo/android-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayPo Android Drop-in"
description: "Add PayPo to your Drop-in integration."
url: "https://docs.adyen.com/payment-methods/paypo/android-drop-in"
source_url: "https://docs.adyen.com/payment-methods/paypo/android-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/paypo/android-drop-in"
last_modified: "2026-09-15T14:06:04+02:00"
language: "en"
---

# PayPo Android Drop-in
...
| **Action handling**  | Make sure that your existing integration is set up to [handle the additional action](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Drop-in#handle-the-redirect). `action.type`: ****redirect****. |   |
| **Setup steps**      | Before you begin, [add PayPo in your Customer Area](/payment-methods/add-payment-methods).                                                                                                                                               |   |
