<!-- Source URL: https://docs.adyen.com/payment-methods/paypo/flutter-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayPo Flutter Drop-in"
description: "Add PayPo to your Drop-in integration."
url: "https://docs.adyen.com/payment-methods/paypo/flutter-drop-in"
source_url: "https://docs.adyen.com/payment-methods/paypo/flutter-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/paypo/flutter-drop-in"
last_modified: "2026-09-15T14:06:04+02:00"
language: "en"
---

# PayPo Flutter Drop-in

Add PayPo to your Drop-in integration.
...
| **Setup steps**      | Before you begin, contact our [Support Team](https://ca-test.adyen.com/ca/ca/contactUs/support.shtml?form=other) to add PayPo in your Customer Area.                          |   |
...
| **Action handling**  | Make sure that your existing integration is set up to [handle the additional action](/online-payments/build-your-integration/advanced-flow/?platform=Flutter\&integration=Drop-in#handle-the-redirect). `action.type`: ****redirect****. |   |
