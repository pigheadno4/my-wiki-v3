<!-- Source URL: https://docs.adyen.com/payment-methods/napas-card/android-component/earlier-versions.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Napas card Redirect Component v4.x.x integration"
description: "Add Napas card to an existing Components integration."
url: "https://docs.adyen.com/payment-methods/napas-card/android-component/earlier-versions"
source_url: "https://docs.adyen.com/payment-methods/napas-card/android-component/earlier-versions.md"
canonical: "https://docs.adyen.com/payment-methods/napas-card/android-component/earlier-versions"
last_modified: "2019-09-06T17:19:00+02:00"
language: "en"
---

# Napas card Redirect Component v4.x.x integration

Add Napas card to an existing Components integration.

If you have an existing Android Components integration, you can use our Redirect Component to redirect the shopper to the Napas card app or website where they can complete the payment.

When making an Napas card payment, you need to:

* [Include Napas card in the list of available payment methods](#show-in-your-payment-form).
...
1. From your server, make a [/payments](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments) request, specifying:
   ...
   * `paymentMethod.type`: Set this to **momo\_atm**.
...
1. Use the [Redirect Component](/online-payments/build-your-integration/sessions-flow/?platform=Android\&integration=Components#handle-a-redirect) to redirect the shopper to Napas card.
