<!-- Source URL: https://docs.adyen.com/payment-methods/cash-app-afterpay/web-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Cash App Afterpay Component"
description: "Add Cash App Afterpay to your existing Components integration."
url: "https://docs.adyen.com/payment-methods/cash-app-afterpay/web-component"
source_url: "https://docs.adyen.com/payment-methods/cash-app-afterpay/web-component.md"
canonical: "https://docs.adyen.com/payment-methods/cash-app-afterpay/web-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Cash App Afterpay Component

Add Cash App Afterpay to your existing Components integration.

This page explains how to add Cash App Afterpay to your existing Web Components integration.
...
3. Make sure that you use a supported combination of [country/region and currency](/payment-methods/cash-app-afterpay).
...
```html
 <div id="afterpaytouch_US-container"></div>
```
...
```js
const afterpaytouch_US = new Afterpay(checkout).mount('#afterpaytouch_US-container');
```
...
```js
const afterpaytouch_USComponent = checkout.create('afterpaytouch_US').mount('#afterpaytouch_US-container');
```
