<!-- Source URL: https://docs.adyen.com/payment-methods/finland-online-banking/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Online banking Finland Android Component"
description: "Add Online banking Finland to your Components integration."
url: "https://docs.adyen.com/payment-methods/finland-online-banking/android-component"
source_url: "https://docs.adyen.com/payment-methods/finland-online-banking/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/finland-online-banking/android-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Online banking Finland Android Component
...
## Import the Component for Online banking Finland

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Online banking Finland.
...
## Launch and show the Component for Online banking Finland

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Online banking Finland, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("ebanking_FI")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Online banking Finland.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Online banking Finland, use the `InstantPaymentComponent` class.
