<!-- Source URL: https://docs.adyen.com/payment-methods/paybright/web-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayBright Component"
description: "Add PayBright to an existing Components integration."
url: "https://docs.adyen.com/payment-methods/paybright/web-component"
source_url: "https://docs.adyen.com/payment-methods/paybright/web-component.md"
canonical: "https://docs.adyen.com/payment-methods/paybright/web-component"
...
This page explains how to add PayBright to your existing Web Components integration.
...
```html
 <div id="paybright-container"></div>
```
...
```js
const paybright = new Redirect(checkout, { type: 'paybright' }).mount('#paybright-container');
```
...
```js
const paybrightComponent = checkout.create('paybright').mount('#paybright-container');
```
