<!-- Source URL: https://docs.adyen.com/payment-methods/paybright/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayBright for API only"
description: "Add PayBright to an existing API-only integration."
url: "https://docs.adyen.com/payment-methods/paybright/api-only"
source_url: "https://docs.adyen.com/payment-methods/paybright/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/paybright/api-only"
...
| **Setup steps**      | Before you begin, [add PayBright in your test Customer Area](/payment-methods/add-payment-methods).                                                  |
...
specify the following combinations of [countryCode](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) and [amount.currency](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-amount) in your request:

| Country/region | `countryCode` | `amount.currency` |
| -------------- | ------------- | ----------------- |
| Canada         | **CA**        | **CAD**           |

We provide a PayBright logo which you can use on your payment form. For more information, refer to [Downloading logos](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%20only#downloading-logos).
...
Make a [/payments](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments) request from your server, specifying:
...
* [returnUrl](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments#request-returnUrl): The URL where the shopper is redirected back to after completing the payment.
