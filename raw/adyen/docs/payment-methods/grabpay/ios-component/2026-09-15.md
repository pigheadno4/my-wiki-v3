<!-- Source URL: https://docs.adyen.com/payment-methods/grabpay/ios-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "GrabPay iOS Component"
description: "Add GrabPay to your iOS Components integration."
url: "https://docs.adyen.com/payment-methods/grabpay/ios-component"
source_url: "https://docs.adyen.com/payment-methods/grabpay/ios-component.md"
canonical: "https://docs.adyen.com/payment-methods/grabpay/ios-component"
...
This page explains how to add GrabPay to your existing iOS Components integration.
...
guard let paymentMethod = paymentMethods.paymentMethod(ofType: .other("grabpay_SG")) else { return }
...
```swift
// Check that the payment method is supported before showing the Component.
guard let paymentMethod = paymentMethods.paymentMethod(ofType: GrabPayPaymentMethod.self) else { return }
let style = FormComponentStyle()
let component = GrabPayComponent(paymentMethod: paymentMethod,
                                apiContext: context,
                                style: style)
present(component)
```
