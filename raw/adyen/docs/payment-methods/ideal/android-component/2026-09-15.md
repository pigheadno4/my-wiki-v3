<!-- Source URL: https://docs.adyen.com/payment-methods/ideal/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "iDEAL | Wero Android Component"
description: "Add iDEAL | Wero to your Components integration."
url: "https://docs.adyen.com/payment-methods/ideal/android-component"
source_url: "https://docs.adyen.com/payment-methods/ideal/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/ideal/android-component"
last_modified: "2026-09-15T14:06:03+02:00"
language: "en"
---

# iDEAL | Wero Android Component
...
## Import the Component for iDEAL | Wero

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for iDEAL | Wero.
...
```java
implementation "com.adyen.checkout:ideal:YOUR_VERSION"
...
## Launch and show the Component for iDEAL | Wero

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for iDEAL | Wero, use the `IdealComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod(PaymentMethodTypes.IDEAL)
...
binding.idealView.attach(idealComponent, activity) // Your activity or fragment.
```
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for iDEAL | Wero.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for iDEAL | Wero, use the `IdealComponent` class.
...
val paymentMethod = paymentMethodsApiResponse?.paymentMethods.orEmpty().firstOrNull {
  it.type == PaymentMethodTypes.IDEAL
}
