<!-- Source URL: https://docs.adyen.com/payment-methods/pix/flutter-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Pix Flutter Drop-in"
description: "Add Pix to your Drop-in integration."
url: "https://docs.adyen.com/payment-methods/pix/flutter-drop-in"
source_url: "https://docs.adyen.com/payment-methods/pix/flutter-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/pix/flutter-drop-in"
...
| **Setup steps**      | Before you begin, contact our [Support Team](https://ca-test.adyen.com/ca/ca/contactUs/support.shtml?form=other) to add Pix in your Customer Area.                            |   |
...
| **Action handling**  | Make sure that your existing integration is set up to [handle the additional action](/online-payments/build-your-integration/advanced-flow/?platform=Flutter\&integration=Drop-in#handle-the-redirect). `action.type`: **qrCode**. |   |
