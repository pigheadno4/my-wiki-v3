<!-- Source URL: https://docs.adyen.com/payment-methods/pix/ios-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Pix iOS Component"
description: "Add Pix to your Components integration."
url: "https://docs.adyen.com/payment-methods/pix/ios-component"
source_url: "https://docs.adyen.com/payment-methods/pix/ios-component.md"
canonical: "https://docs.adyen.com/payment-methods/pix/ios-component"
...
To [initialize](#initialize-the-component) Pix, use the `InstantPaymentComponent` class.
...
guard let paymentMethod = paymentMethods.paymentMethod(ofType: .other("pix")) else { return }
...
| **Action handling**  | Make sure that your existing integration is set up to [handle the additional action](/online-payments/build-your-integration/advanced-flow/?platform=iOS\&integration=Components#handle-the-redirect). `action.type`: **qrCode**. |   |
| **Setup steps**      | Before you begin, [add Pix in your Customer Area](/payment-methods/add-payment-methods).                                                                                                                                          |   |
