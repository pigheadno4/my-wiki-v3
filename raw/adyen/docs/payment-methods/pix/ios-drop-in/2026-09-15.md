<!-- Source URL: https://docs.adyen.com/payment-methods/pix/ios-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Pix iOS Drop-in"
description: "Add Pix to your Drop-in integration."
url: "https://docs.adyen.com/payment-methods/pix/ios-drop-in"
source_url: "https://docs.adyen.com/payment-methods/pix/ios-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/pix/ios-drop-in"
...
| **Action handling**  | Make sure that your existing integration is set up to [handle the additional action](/online-payments/build-your-integration/advanced-flow/?platform=iOS\&integration=Drop-in#handle-the-redirect). `action.type`: **qrCode**. |   |
| **Setup steps**      | Before you begin, [add Pix in your Customer Area](/payment-methods/add-payment-methods).                                                                                                                                       |   |
