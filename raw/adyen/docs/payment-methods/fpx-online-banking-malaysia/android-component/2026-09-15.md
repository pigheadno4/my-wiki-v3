<!-- Source URL: https://docs.adyen.com/payment-methods/fpx-online-banking-malaysia/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "FPX Online Banking Malaysia Android Component"
description: "Add FPX Online Banking Malaysia to your Components integration."
url: "https://docs.adyen.com/payment-methods/fpx-online-banking-malaysia/android-component"
source_url: "https://docs.adyen.com/payment-methods/fpx-online-banking-malaysia/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/fpx-online-banking-malaysia/android-component"
last_modified: "2026-09-15T14:06:04+02:00"
language: "en"
---

# FPX Online Banking Malaysia Android Component
...
## Import the Component for FPX Online Banking Malaysia

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for FPX Online Banking Malaysia.
...
## Launch and show the Component for FPX Online Banking Malaysia

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for FPX Online Banking Malaysia, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("molpay_ebanking_fpx_MY")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for FPX Online Banking Malaysia.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for FPX Online Banking Malaysia, use the `InstantPaymentComponent` class.
...
val paymentMethod = paymentMethodsApiResponse?.paymentMethods.orEmpty().firstOrNull {
  it.type == "molpay_ebanking_fpx_MY"
}
