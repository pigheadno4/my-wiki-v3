<!-- Source URL: https://docs.adyen.com/payment-methods/paysafecard/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PaySafeCard Android Component"
description: "Add PaySafeCard to your Components integration."
url: "https://docs.adyen.com/payment-methods/paysafecard/android-component"
source_url: "https://docs.adyen.com/payment-methods/paysafecard/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/paysafecard/android-component"
...
## Import the Component for PaySafeCard

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for PaySafeCard.
...
## Launch and show the Component for PaySafeCard

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for PaySafeCard, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("paysafecard")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for PaySafeCard.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for PaySafeCard, use the `InstantPaymentComponent` class.
