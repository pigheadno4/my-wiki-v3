<!-- Source URL: https://docs.adyen.com/payment-methods/alipayhk/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Alipay HK Android Component"
description: "Add Alipay HK to your Components integration."
url: "https://docs.adyen.com/payment-methods/alipayhk/android-component"
source_url: "https://docs.adyen.com/payment-methods/alipayhk/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/alipayhk/android-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Alipay HK Android Component
...
## Import the Component for Alipay HK

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Alipay HK.
...
## Launch and show the Component for Alipay HK

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Alipay HK, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("alipay_hk")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Alipay HK.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Alipay HK, use the `InstantPaymentComponent` class.
