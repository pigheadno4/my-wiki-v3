<!-- Source URL: https://docs.adyen.com/payment-methods/kakaopay/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "KakaoPay Android Component"
description: "Add KakaoPay to your Components integration."
url: "https://docs.adyen.com/payment-methods/kakaopay/android-component"
source_url: "https://docs.adyen.com/payment-methods/kakaopay/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/kakaopay/android-component"
last_modified: "2026-09-15T14:06:03+02:00"
language: "en"
---

# KakaoPay Android Component
...
## Import the Component for KakaoPay

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for KakaoPay.
...
## Launch and show the Component for KakaoPay

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for KakaoPay, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("kakaopay")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for KakaoPay.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for KakaoPay, use the `InstantPaymentComponent` class.
