<!-- Source URL: https://docs.adyen.com/payment-methods/kakaopay/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "KakaoPay for API only"
description: "Add KakaoPay to your API-only integration."
url: "https://docs.adyen.com/payment-methods/kakaopay/api-only"
source_url: "https://docs.adyen.com/payment-methods/kakaopay/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/kakaopay/api-only"
last_modified: "2026-09-15T14:06:03+02:00"
language: "en"
---

# KakaoPay for API only

Add KakaoPay to your API-only integration.
...
1. The shopper selects KakaoPay as the payment method.
...
Include KakaoPay in the list of available payment methods. You do not need to collect any information from the shopper in your payment form.

You can [download the logo for KakaoPay](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%2Bonly\&version=71#downloading-logos) to use in your form.

## Get KakaoPay as an available payment method

When you make the [/paymentMethods](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) to [get available payment methods](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%20only#get-available-payment-methods), specify the following so that KakaoPay is included in the response.
...
**Example response with KakaoPay available**
