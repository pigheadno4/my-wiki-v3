<!-- Source URL: https://docs.adyen.com/payment-methods/afterpaytouch/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Afterpay Android Component"
description: "Add Afterpay to your Components integration."
url: "https://docs.adyen.com/payment-methods/afterpaytouch/android-component"
source_url: "https://docs.adyen.com/payment-methods/afterpaytouch/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/afterpaytouch/android-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Afterpay Android Component
...
## Import the Component for Afterpay

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Afterpay.
...
## Launch and show the Component for Afterpay

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Afterpay, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("afterpaytouch")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Afterpay.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Afterpay, use the `InstantPaymentComponent` class.
