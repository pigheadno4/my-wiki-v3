<!-- Source URL: https://docs.adyen.com/payment-methods/dana/web-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "DANA Web Component"
description: "Add DANA to your Components integration."
url: "https://docs.adyen.com/payment-methods/dana/web-component"
source_url: "https://docs.adyen.com/payment-methods/dana/web-component.md"
canonical: "https://docs.adyen.com/payment-methods/dana/web-component"
...
Add DANA to your Components integration.

You can add DANA to your existing integration. The following instructions show only what you must add to your integration specifically for DANA.
...
| **Setup steps**       | Before you begin, [add DANA in your Customer Area](/payment-methods/add-payment-methods).                                                                                                                                |   |
...
## Add additional configuration for DANA

You do not need to add any configuration parameters for DANA.

### Initialize

## Initialize the Component for DANA

To [initialize](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Components#initialize-the-payment-session) DANA, use the `Redirect` class.

**Initialize the Component**

```javascript
const redirectComponent = new Redirect(checkout, { type:dana }).mount('#redirect-container')
```
...
To test successful DANA live payments, you need to use a real mobile number registered with a [DANA account](https://www.dana.id/en/download).

If you are encountering issues with testing DANA payments, contact our [Support Team](https://ca-test.adyen.com/ca/ca/contactUs/support.shtml?form=other).

Check the status of DANA test payments in your [Customer Area](https://ca-test.adyen.com/) > **Payments** > **Payment list**.

Before you can accept live DANA payments, you need to submit a request for DANA in your [live Customer Area](https://ca-live.adyen.com/).
...
To [initialize](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=Components#initialize-the-payment-session) DANA, use the `Redirect` class.
