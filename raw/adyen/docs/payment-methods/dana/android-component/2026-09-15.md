<!-- Source URL: https://docs.adyen.com/payment-methods/dana/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "DANA Android Component"
description: "Add DANA to your Components integration."
url: "https://docs.adyen.com/payment-methods/dana/android-component"
source_url: "https://docs.adyen.com/payment-methods/dana/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/dana/android-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# DANA Android Component
...
## Import the Component for DANA

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for DANA.
...
## Launch and show the Component for DANA

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for DANA, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("dana")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for DANA.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for DANA, use the `InstantPaymentComponent` class.
