<!-- Source URL: https://docs.adyen.com/payment-methods/dana/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "DANA for API only"
description: "Add DANA to your API-only integration."
url: "https://docs.adyen.com/payment-methods/dana/api-only"
source_url: "https://docs.adyen.com/payment-methods/dana/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/dana/api-only"
...
Add DANA to your API-only integration.
...
1. The shopper selects DANA as the payment method.
...
**Example response with DANA available**
