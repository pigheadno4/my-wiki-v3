<!-- Source URL: https://docs.adyen.com/payment-methods/sepa-direct-debit/web-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "SEPA Direct Debit Web Component"
description: "Add SEPA Direct Debit to your Components integration."
url: "https://docs.adyen.com/payment-methods/sepa-direct-debit/web-component"
source_url: "https://docs.adyen.com/payment-methods/sepa-direct-debit/web-component.md"
canonical: "https://docs.adyen.com/payment-methods/sepa-direct-debit/web-component"
last_modified: "2026-09-15T14:06:04+02:00"
language: "en"
---

# SEPA Direct Debit Web Component

Add SEPA Direct Debit to your Components integration.
...
## Import SEPA Direct Debit

When you [import Adyen Web](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Components#get-adyen-web), include `SepaDirectDebit`.
...
## Initialize the Component for SEPA Direct Debit

To [initialize](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Components#initialize-the-payment-session) SEPA Direct Debit, use the `SepaDirectDebit` class.

**Initialize the Component**

```javascript
const sepaDirectDebitComponent = new SepaDirectDebit(checkout,
    {
    // The configuration object for SEPA Direct Debit that you created.
    // Mount the Component to a container.
    }).mount('#sepaDirectDebit-container')
```
...
When you [import Adyen Web](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=Components#get-adyen-web), include `SepaDirectDebit`.
...
To [initialize](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=Components#initialize-the-payment-session) SEPA Direct Debit, use the `SepaDirectDebit` class.
