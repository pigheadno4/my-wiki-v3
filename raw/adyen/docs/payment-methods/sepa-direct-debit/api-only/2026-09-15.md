<!-- Source URL: https://docs.adyen.com/payment-methods/sepa-direct-debit/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "SEPA Direct Debit for API only"
description: "Add SEPA Direct Debit to your API-only integration."
url: "https://docs.adyen.com/payment-methods/sepa-direct-debit/api-only"
source_url: "https://docs.adyen.com/payment-methods/sepa-direct-debit/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/sepa-direct-debit/api-only"
...
4. If you do not use automatic capture, you must [capture the payment](#capture-the-payment).
...
2. After the shopper selects SEPA, render the input fields for SEPA to collect their issuer selection. You'll need this to make a payment.
   ...
   | ---------------------------------- | -------------------- |
   | The name on the SEPA bank account. | "A. Klaassen"        |
   | The IBAN of the bank account.      | "NL98ABNA0410108103" |

You can [download the logo for SEPA Direct Debit](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%2Bonly\&version=71#downloading-logos) to use in your form.

## Get SEPA Direct Debit as an available payment method

When you make the [/paymentMethods](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) to [get available payment methods](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%20only#get-available-payment-methods), specify the following so that SEPA Direct Debit is included in the response.

| Parameter                                                                                                          | Values                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [countryCode](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-countryCode)         | **AT**, **BE**, **CY**, **EE**, **FI**, **FR**, **DE**, **GR**, **IE**, **IT**, **LV**, **LT**, **LU**, **MT**, **NL**, **PT**, **SK**, **SI**, **ES** |
...
**Example response with SEPA Direct Debit available**
