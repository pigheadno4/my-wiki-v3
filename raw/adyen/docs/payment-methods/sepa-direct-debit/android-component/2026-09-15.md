<!-- Source URL: https://docs.adyen.com/payment-methods/sepa-direct-debit/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "SEPA Direct Debit Android Component"
description: "Add SEPA Direct Debit to your Components integration."
url: "https://docs.adyen.com/payment-methods/sepa-direct-debit/android-component"
source_url: "https://docs.adyen.com/payment-methods/sepa-direct-debit/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/sepa-direct-debit/android-component"
...
## Import the Component for SEPA Direct Debit

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for SEPA Direct Debit.
...
```java
implementation "com.adyen.checkout:sepa:YOUR_VERSION"
...
## Launch and show the Component for SEPA Direct Debit

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for SEPA Direct Debit, use the `SepaComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod(PaymentMethodTypes.SEPA)

@Composable
private fun ComposableSepaComponent() {
  // Keep a reference to this Component in case you need to access it later.
  val sepaComponent = SepaComponent.PROVIDER.get(
...
binding.sepaView.attach(sepaComponent, activity) // Your activity or fragment.
```
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for SEPA Direct Debit.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for SEPA Direct Debit, use the `SepaComponent` class.
...
val paymentMethod = paymentMethodsApiResponse?.paymentMethods.orEmpty().firstOrNull {
  it.type == PaymentMethodTypes.SEPA
}
