<!-- Source URL: https://docs.adyen.com/payment-methods/momo-wallet/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "MoMo for API only"
description: "Add MoMo to your API-only integration."
url: "https://docs.adyen.com/payment-methods/momo-wallet/api-only"
source_url: "https://docs.adyen.com/payment-methods/momo-wallet/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/momo-wallet/api-only"
...
You can [download the logo for MoMo](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%2Bonly\&version=71#downloading-logos) to use in your form.

## Get MoMo as an available payment method

When you make the [/paymentMethods](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) to [get available payment methods](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%20only#get-available-payment-methods), specify the following so that MoMo is included in the response.

| Parameter                                                                                                          | Values                                                |
| ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- |
| [countryCode](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-countryCode)         | ****VN****                                            |
| [amount.currency](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods#request-amount-currency) | ****VND****                                           |
...
**Example response with MoMo available**
