<!-- Source URL: https://docs.adyen.com/payment-methods/momo-wallet/web-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "MoMo Web Component"
description: "Add MoMo to your Components integration."
url: "https://docs.adyen.com/payment-methods/momo-wallet/web-component"
source_url: "https://docs.adyen.com/payment-methods/momo-wallet/web-component.md"
canonical: "https://docs.adyen.com/payment-methods/momo-wallet/web-component"
...
To [initialize](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Components#initialize-the-payment-session) MoMo, use the `Redirect` class.

**Initialize the Component**

```javascript
const redirectComponent = new Redirect(checkout, { type:momo_wallet }).mount('#redirect-container')
```
...
To [initialize](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=Components#initialize-the-payment-session) MoMo, use the `Redirect` class.
