<!-- Source URL: https://docs.adyen.com/payment-methods/bank-transfer-kcp/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Bank Transfer via KCP for API only"
description: "Add Bank Transfer via KCP to your API-only integration."
url: "https://docs.adyen.com/payment-methods/bank-transfer-kcp/api-only"
source_url: "https://docs.adyen.com/payment-methods/bank-transfer-kcp/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/bank-transfer-kcp/api-only"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Bank Transfer via KCP for API only

Add Bank Transfer via KCP to your API-only integration.
...
1. The shopper selects Bank Transfer via KCP as the payment method.
...
Include Bank Transfer via KCP in the list of available payment methods. There are no additional fields that you have to include in your form.

You can [download the logo for Bank Transfer via KCP](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%2Bonly\&version=71#downloading-logos) to use in your form.

## Get Bank Transfer via KCP as an available payment method

When you make the [/paymentMethods](https://docs.adyen.com/api-explorer/Checkout/latest/post/paymentMethods) to [get available payment methods](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%20only#get-available-payment-methods), specify the following so that Bank Transfer via KCP is included in the response.
...
**Example response with Bank Transfer via KCP available**
...
**Example payment request for Bank Transfer via KCP**
...
PaymentDetails paymentDetails = new PaymentDetails()
  .type(PaymentDetails.TypeEnum.KCP_BANKTRANSFER);
...
PaymentDetails paymentDetails = new PaymentDetails
{
  Type = PaymentDetails.TypeEnum.KcpBanktransfer
};
...
paymentDetails := checkout.PaymentDetails{
  Type: common.PtrString("kcp_banktransfer"),
}
...
const paymentDetails: Types.checkout.PaymentDetails = {
  type: Types.checkout.PaymentDetails.TypeEnum.KcpBanktransfer
};
...
```json
{
   ...
   "action": {
       "paymentMethodType": "kcp_banktransfer",
       "method": "GET",
...
Your existing integration setup will [handle the redirect](/online-payments/build-your-integration/advanced-flow/?platform=Web\&integration=API%20only#handle-the-redirect).
