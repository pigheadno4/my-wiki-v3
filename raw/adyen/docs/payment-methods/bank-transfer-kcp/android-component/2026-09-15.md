<!-- Source URL: https://docs.adyen.com/payment-methods/bank-transfer-kcp/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Bank Transfer via KCP Android Component"
description: "Add Bank Transfer via KCP to your Components integration."
url: "https://docs.adyen.com/payment-methods/bank-transfer-kcp/android-component"
source_url: "https://docs.adyen.com/payment-methods/bank-transfer-kcp/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/bank-transfer-kcp/android-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Bank Transfer via KCP Android Component
...
## Import the Component for Bank Transfer via KCP

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Bank Transfer via KCP.
...
## Launch and show the Component for Bank Transfer via KCP

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Bank Transfer via KCP, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("kcp_banktransfer")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Bank Transfer via KCP.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Bank Transfer via KCP, use the `InstantPaymentComponent` class.
