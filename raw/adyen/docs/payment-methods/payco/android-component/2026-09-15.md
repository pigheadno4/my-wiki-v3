<!-- Source URL: https://docs.adyen.com/payment-methods/payco/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayCo Android Component"
description: "Add PayCo to your Components integration."
url: "https://docs.adyen.com/payment-methods/payco/android-component"
source_url: "https://docs.adyen.com/payment-methods/payco/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/payco/android-component"
last_modified: "2026-09-15T14:06:04+02:00"
language: "en"
---

# PayCo Android Component
...
## Import the Component for PayCo

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for PayCo.
...
## Launch and show the Component for PayCo

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for PayCo, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("kcp_payco")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for PayCo.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for PayCo, use the `InstantPaymentComponent` class.
