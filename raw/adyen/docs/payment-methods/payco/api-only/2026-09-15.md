<!-- Source URL: https://docs.adyen.com/payment-methods/payco/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "PayCo for API only"
description: "Add PayCo to your API-only integration."
url: "https://docs.adyen.com/payment-methods/payco/api-only"
source_url: "https://docs.adyen.com/payment-methods/payco/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/payco/api-only"
...
**Example response with PayCo available**
...
**Example payment request for PayCo**
...
PaymentDetails paymentDetails = new PaymentDetails()
  .type(PaymentDetails.TypeEnum.KCP_PAYCO);
...
PaymentDetails paymentDetails = new PaymentDetails
{
  Type = PaymentDetails.TypeEnum.KcpPayco
};
...
paymentDetails := checkout.PaymentDetails{
  Type: common.PtrString("kcp_payco"),
}
...
const paymentDetails: Types.checkout.PaymentDetails = {
  type: Types.checkout.PaymentDetails.TypeEnum.KcpPayco
};
