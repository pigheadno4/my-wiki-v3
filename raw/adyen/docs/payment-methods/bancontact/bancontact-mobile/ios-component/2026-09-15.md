<!-- Source URL: https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/ios-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/ios-component"
source_url: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/ios-component.md"
canonical: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/ios-component"
...
Our [iOS Component](/online-payments/build-your-integration/sessions-flow?platform=iOS\&integration=Components) renders Bancontact in your payment form, and redirects the shopper to the Bancontact app depending on how they are accessing your app:
...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Integration type** | Make sure that you have built your [iOS Components integration](/online-payments/build-your-integration/sessions-flow?platform=iOS\&integration=Components).                                                                                                                                                                                                          |
