<!-- Source URL: https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/web-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Bancontact mobile Component"
description: "Add Bancontact mobile to an existing Components integration."
url: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/web-component"
source_url: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/web-component.md"
canonical: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/web-component"
...
Use our [Component](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Components) to redirect the shopper to the Bancontact app, depending on how they are accessing your site:
...
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Integration type** | Make sure that you have built your [Web Components integration](/online-payments/build-your-integration/sessions-flow?platform=Web\&integration=Components).                                                                                                                                                                                                                 |
...
If you are using Web Components v6, [import the Component](/online-payments/build-your-integration/?platform=Web\&integration=Drop-in\&version=6.0.0) that you need for Bancontact mobile:

```js
import { AdyenCheckout, BcmcMobile } from '@adyen/adyen-web'
```
...
```js
const bcmcMobile = new BcmcMobile(checkout, {type: "bcmc_mobile"}).mount("#bcmc_mobile-container");
```
