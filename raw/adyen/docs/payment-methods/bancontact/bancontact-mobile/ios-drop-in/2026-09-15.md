<!-- Source URL: https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/ios-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/ios-drop-in"
source_url: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/ios-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/bancontact/bancontact-mobile/ios-drop-in"
...
This page explains how to add Bancontact to your existing iOS Drop-in integration.

Our [iOS Drop-in](/online-payments/build-your-integration/sessions-flow?platform=iOS\&integration=Drop-in) renders Bancontact in your payment form, and redirects the shopper to the Bancontact app depending on how they are accessing your app:
...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Integration type** | Make sure that you have built your [iOS Drop-in integration](/online-payments/build-your-integration/sessions-flow?platform=iOS\&integration=Drop-in).                                                                                                                                                                                                                |
...
There is no required Bancontact-specific integration for Drop-in.
