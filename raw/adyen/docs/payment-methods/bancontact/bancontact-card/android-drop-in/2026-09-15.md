<!-- Source URL: https://docs.adyen.com/payment-methods/bancontact/bancontact-card/android-drop-in.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/payment-methods/bancontact/bancontact-card/android-drop-in"
source_url: "https://docs.adyen.com/payment-methods/bancontact/bancontact-card/android-drop-in.md"
canonical: "https://docs.adyen.com/payment-methods/bancontact/bancontact-card/android-drop-in"
...
This page explains how to add Bancontact card to your existing Android Drop-in integration.

This page is for **v5.0.0**, released in October 2023. If you are using an earlier version, use [the guide for earlier versions](/payment-methods/bancontact/bancontact-card/android-drop-in/earlier-versions) instead.
...
When you [make the `/sessions` request](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Drop-in#create-a-payment-session), Bancontact card does not require any additional fields.

### Tab: Advanced flow

When you [make the `/payments` request](/online-payments/build-your-integration/advanced-flow?platform=Android\&integration=Drop-in#make-a-payment), Bancontact card does not require any additional fields.

## Drop-in Configuration

### Tab: Sessions flow

When you [configure](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Drop-in#configure) Drop-in, Bancontact card does not require any additional configuration.

### Tab: Advanced flow

When you [configure](/online-payments/build-your-integration/advanced-flow?platform=Android\&integration=Drop-in#configure) Drop-in, Bancontact card does not require any additional configuration.
