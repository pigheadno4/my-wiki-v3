<!-- Source URL: https://docs.adyen.com/payment-methods/boost/android-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Boost Wallet Android Component"
description: "Add Boost Wallet to your Components integration."
url: "https://docs.adyen.com/payment-methods/boost/android-component"
source_url: "https://docs.adyen.com/payment-methods/boost/android-component.md"
canonical: "https://docs.adyen.com/payment-methods/boost/android-component"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Boost Wallet Android Component
...
## Import the Component for Boost Wallet

To [import the library](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#import) and include the module for Boost Wallet.
...
## Launch and show the Component for Boost Wallet

To [create the Component](/online-payments/build-your-integration/sessions-flow?platform=Android\&integration=Components#launch-and-show) for Boost Wallet, use the `InstantPaymentComponent` class.
...
val paymentMethod = checkoutSession.getPaymentMethod("molpay_boost")
...
To [import the library](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#import) and include the module for Boost Wallet.
...
To [create the Component](/online-payments/build-your-integration/advanced-flow/?platform=Android\&integration=Components#launch-and-show) for Boost Wallet, use the `InstantPaymentComponent` class.
