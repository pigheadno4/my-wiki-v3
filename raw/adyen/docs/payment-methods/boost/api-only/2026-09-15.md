<!-- Source URL: https://docs.adyen.com/payment-methods/boost/api-only.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Boost Wallet for API only"
description: "Add Boost Wallet to your API-only integration."
url: "https://docs.adyen.com/payment-methods/boost/api-only"
source_url: "https://docs.adyen.com/payment-methods/boost/api-only.md"
canonical: "https://docs.adyen.com/payment-methods/boost/api-only"
last_modified: "2026-09-15T12:56:53+02:00"
language: "en"
---

# Boost Wallet for API only

Add Boost Wallet to your API-only integration.
...
1. The shopper selects Boost Wallet as the payment method.
...
**Example response with Boost Wallet available**
...
**Example payment request for Boost Wallet**
...
```json
{
    ...
    "action": {
        "paymentMethodType": "molpay_boost",
        "method": "GET",
