<!-- Source URL: https://docs.adyen.com/online-payments/upgrade-your-integration/upgrade-to-web-v6/from-v4.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Upgrade to Adyen Web v6"
description: "Make the changes required to upgrade from Web Drop-in/Components v4.x.x to v6.x.x."
url: "https://docs.adyen.com/online-payments/upgrade-your-integration/upgrade-to-web-v6/from-v4"
source_url: "https://docs.adyen.com/online-payments/upgrade-your-integration/upgrade-to-web-v6/from-v4.md"
canonical: "https://docs.adyen.com/online-payments/upgrade-your-integration/upgrade-to-web-v6/from-v4"
...
Make the changes required to upgrade from Web Drop-in/Components v4.x.x to v6.x.x.
...
To upgrade from [Web Drop-in/Components](https://github.com/Adyen/adyen-web) v4.x.x to v6.x.x, complete the following steps.
