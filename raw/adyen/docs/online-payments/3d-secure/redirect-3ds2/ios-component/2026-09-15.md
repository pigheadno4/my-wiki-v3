<!-- Source URL: https://docs.adyen.com/online-payments/3d-secure/redirect-3ds2/ios-component.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/online-payments/3d-secure/redirect-3ds2/ios-component"
source_url: "https://docs.adyen.com/online-payments/3d-secure/redirect-3ds2/ios-component.md"
canonical: "https://docs.adyen.com/online-payments/3d-secure/redirect-3ds2/ios-component"
last_modified: "2021-05-11T17:34:00+02:00"
language: "en"
---
...
1. Make sure that you have integrated our [Card Component](/payment-methods/cards/ios-component), or [built your own UI](/payment-methods/cards/api-only) for collecting shopper's card details.
...
1. When you [make a payment request](/online-payments/build-your-integration/advanced-flow?platform=iOS\&integration=Drop-in\&version=latest#make-a-payment), include the following additional 3D Secure 2 parameters.
...
3. From your server, make a POST [/payments/details](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments/details) request providing the `data` from the `didProvide` method from your client app.
...
For more information and detailed instructions, refer to [Using the Redirect Component](/online-payments/build-your-integration/sessions-flow/?platform=iOS\&integration=Components#handle-the-redirect).
