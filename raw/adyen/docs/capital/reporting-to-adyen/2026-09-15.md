<!-- Source URL: https://docs.adyen.com/capital/reporting-to-adyen.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/capital/reporting-to-adyen"
source_url: "https://docs.adyen.com/capital/reporting-to-adyen.md"
canonical: "https://docs.adyen.com/capital/reporting-to-adyen"
...
* The platform receives a Security, Regulatory or Legal Complaint. You must notify Adyen of these complaints, using the [dedicated template](/capital/reporting-to-adyen/Adyen_Complaints_Reporting.xlsx) for complaints reporting. Also see [How to make a complaint](https://www.adyen.com/contact/complaint).
...
* Customer Support Circumstances (these are to be raised through normal Adyen support lines):
  ...
  * Any explicit statement made from a user through customer support channels that they are facing difficulties repaying the loan.
...
* [Keeping records](/capital/keeping-records)
