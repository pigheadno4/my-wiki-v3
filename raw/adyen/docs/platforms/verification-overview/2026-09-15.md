<!-- Source URL: https://docs.adyen.com/platforms/verification-overview.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/platforms/verification-overview"
source_url: "https://docs.adyen.com/platforms/verification-overview.md"
canonical: "https://docs.adyen.com/platforms/verification-overview"
...
During this process, Adyen verifies that your users provide accurate information about their businesses. Based on the results of the verification checks, Adyen decides if a user can perform any action on your platform. These actions are known as [*capabilities* ](/platforms/verification-overview/capabilities).

To see whether a user can use a specific capability on your platform, check the [capability settings](/platforms/verification-overview/capabilities#capability-settings).
...
In the [design phase](/platforms/get-started##design-implementation), you set the default capabilities for your platform. These capabilities are requested every time you onboard a new user and create an account holder for them. Adyen verifies the user and if they successfully complete the verification checks, they are allowed to use the capabilities.

If a user needs a specific capability that is not requested by default, you must [request the additional capability](/platforms/manage-account-holders#request-capability). In some cases, this requires more verification.
...
Adyen occasionally requires your users to [review and confirm](/platforms/verification-overview#when-adyen-requires-data-reviews) that their data is up-to-date. You also can choose to [proactively request the data review](/platforms/verification-overview/data-review-process#proactive-review) for your user.
...
* [View the details of the account holder](/platforms/manage-account-holders?tab=ah-customer-area_1#get-account-holders) in your Customer Area.
...
In the following diagrams, you can see the process for events that trigger verification checks and the relationship between [capability verification statuses](/platforms/verification-overview/capabilities#verification-status-of-a-capability) and [capability settings](/platforms/verification-overview/capabilities#capability-settings).
...
[Verification types](/platforms/verification-overview/verification-types)

[Learn when to collect verification information from your users](/platforms/verification-overview/verification-types)

[User capabilities](/platforms/verification-overview/capabilities)

[Learn what capabilities your users can have in your platform](/platforms/verification-overview/capabilities)

[required](/platforms/onboard-users)

[Onboard your users](/platforms/onboard-users)
