<!-- Source URL: https://docs.adyen.com/platforms/internal-fund-transfers/internal-transfer-webhooks.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Webhooks for internal funds transfers"
description: "Find out which webhooks Adyen sends for internal funds transfers."
url: "https://docs.adyen.com/platforms/internal-fund-transfers/internal-transfer-webhooks"
source_url: "https://docs.adyen.com/platforms/internal-fund-transfers/internal-transfer-webhooks.md"
canonical: "https://docs.adyen.com/platforms/internal-fund-transfers/internal-transfer-webhooks"
...
For information on which payment webhooks Adyen sends for internal transfer-related events, see [Payment webhooks (deprecated)](/platforms/internal-fund-transfers/notification-webhooks).
...
When a scheduled or on-demand internal transfer is triggered, we send [balancePlatform.transfer.created](https://docs.adyen.com/api-explorer/transfer-webhooks/latest/post/balancePlatform.transfer.created) webhooks with `status` **received**, to inform your server that funds will be transferred between balance accounts in your platform.
...
If needed, you can [return the funds](/platforms/internal-fund-transfers/return-transfers) to the source balance account.
