<!-- Source URL: https://docs.adyen.com/platforms/onboard-users/components.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/platforms/onboard-users/components"
source_url: "https://docs.adyen.com/platforms/onboard-users/components.md"
canonical: "https://docs.adyen.com/platforms/onboard-users/components"
...
We recommend using the Onboarding components in your [API-only onboarding flow](/platforms/onboard-users) to reduce engineering efforts and speed up implementation. It is important to note that the Onboarding components only cover certain functionality, and you still need to implement API calls for other parts of your API-only onboarding flow.

Here are some scenarios where the Onboarding components can be particularly useful:

* You are developing your UI to onboard users with [API-only onboarding](/platforms/onboard-users#api-only-onboarding) and want to speed up the process.
* You have already built your UI to onboard users with [API-only onboarding](/platforms/onboard-users#api-only-onboarding) and want to reduce the effort required to maintain your code.
* You are using [hosted onboarding](/platforms/onboard-users#hosted-onboarding) to onboard users and want to let users manage their submitted data directly in your UI.
...
[![](/user/pages/filters/onboarding-components-platform/transfer-instrument/4-0-0/component-description/transfer-instrument-configuration-mobile.jpg)](/user/pages/filters/onboarding-components-platform/transfer-instrument/4-0-0/component-description/transfer-instrument-configuration-mobile.jpg)

### Tab: Desktop

[![](/user/pages/filters/onboarding-components-platform/transfer-instrument/4-0-0/component-description/transfer-instrument-configuration-desktop.jpg)](/user/pages/filters/onboarding-components-platform/transfer-instrument/4-0-0/component-description/transfer-instrument-configuration-desktop.jpg)
...
[![](/user/pages/filters/onboarding-components-platform/transfer-instrument/4-0-0/component-description/transfer-instrument-management-mobile.jpg)](/user/pages/filters/onboarding-components-platform/transfer-instrument/4-0-0/component-description/transfer-instrument-management-mobile.jpg)

### Tab: Desktop

[![](/user/pages/filters/onboarding-components-platform/transfer-instrument/4-0-0/component-description/transfer-instrument-management-desktop.jpg)](/user/pages/filters/onboarding-components-platform/transfer-instrument/4-0-0/component-description/transfer-instrument-management-desktop.jpg)
