<!-- Source URL: https://docs.adyen.com/platforms/reconciliation-use-cases/first-year-focus.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
url: "https://docs.adyen.com/platforms/reconciliation-use-cases/first-year-focus"
source_url: "https://docs.adyen.com/platforms/reconciliation-use-cases/first-year-focus.md"
canonical: "https://docs.adyen.com/platforms/reconciliation-use-cases/first-year-focus"
...
[required](/platforms/reconciliation-use-cases/first-year-focus/platform-level-reporting)

[Platform-level reporting](/platforms/reconciliation-use-cases/first-year-focus/platform-level-reporting)

[Read about reporting processes you should prioritize for insights into your platform's business.](/platforms/reconciliation-use-cases/first-year-focus/platform-level-reporting)

[required](/platforms/reconciliation-use-cases/first-year-focus/platform-user-level-reporting)

[User-level reporting](/platforms/reconciliation-use-cases/first-year-focus/platform-user-level-reporting)

[Read about reporting processes you should prioritize for your users to help them understand their profits and costs.](/platforms/reconciliation-use-cases/first-year-focus/platform-user-level-reporting)
