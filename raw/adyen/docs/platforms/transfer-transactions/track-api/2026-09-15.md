<!-- Source URL: https://docs.adyen.com/platforms/transfer-transactions/track-api.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "Track transactions with API requests"
description: "Use the Transfers API to query transactions in your platform."
url: "https://docs.adyen.com/platforms/transfer-transactions/track-api"
source_url: "https://docs.adyen.com/platforms/transfer-transactions/track-api.md"
canonical: "https://docs.adyen.com/platforms/transfer-transactions/track-api"
...
Use the Transfers API to query transactions in your platform.
...
* A [payment](/platforms/process-payments) from a purchase in your platform results in an incoming external transaction.
* A [payout](/platforms/managed-payouts) to one of your users results in an outgoing external transaction.
...
These transactions result from [internal transfers](/platforms/internal-fund-transfers) between balance accounts. The following tabs show example responses that you would get when making a request to get incoming or outgoing internal transactions.
...
* [Track transactions with webhooks](/platforms/transfer-transactions/track-webhooks)
* [View transfer details](/platforms/view-transfers-details)
* [Payout reconciliation](/platforms/payout-reconciliation)
