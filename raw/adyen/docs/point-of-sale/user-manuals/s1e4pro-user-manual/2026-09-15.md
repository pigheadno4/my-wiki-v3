<!-- Source URL: https://docs.adyen.com/point-of-sale/user-manuals/s1e4pro-user-manual.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "S1E4Pro user manual"
description: "Get started with the S1E4Pro payment terminal."
url: "https://docs.adyen.com/point-of-sale/user-manuals/s1e4pro-user-manual"
source_url: "https://docs.adyen.com/point-of-sale/user-manuals/s1e4pro-user-manual.md"
canonical: "https://docs.adyen.com/point-of-sale/user-manuals/s1e4pro-user-manual"
...
Get started with the S1E4Pro payment terminal.

Print this page

![S1E4Pro](/images/a/a/6/8/f/aa68f7930b1c65acfc33441d689ff799cf4d64f4-notexts1e4pro.png)

### Supplied components

* S1E4Pro payment terminal
* Hand strap
...
These are the steps to get your new S1E4Pro payment terminal up and running. Some steps include a link to more detailed instructions.
...
Your S1E4Pro terminal can automatically switch to processing payments using a cellular connection when the internet connection fails. Adyen terminals come with a pre-installed and activated SIM (eSIM) card, so you can use the cellular network immediately to board the terminal.\
...
The S1E4Pro payment terminal is supplied with a USB-C charging cable. This cable is compliant with the [USB industry](https://usb.org/) and [UL](https://www.ul.com/industries/products-and-components/wire-and-cable) standards.
