<!-- Source URL: https://docs.adyen.com/point-of-sale/user-manuals/s1e2l-user-manual.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "S1E2L user manual"
description: "Get started with the S1E2L payment terminal."
url: "https://docs.adyen.com/point-of-sale/user-manuals/s1e2l-user-manual"
source_url: "https://docs.adyen.com/point-of-sale/user-manuals/s1e2l-user-manual.md"
canonical: "https://docs.adyen.com/point-of-sale/user-manuals/s1e2l-user-manual"
last_modified: "2024-12-16T13:58:00+01:00"
language: "en"
---

# S1E2L user manual

Get started with the S1E2L payment terminal.
...
* S1E2L payment terminal
* USB cable and region-specific power plug for charging
* eSIM card
* [Barcode scanning](/point-of-sale/android-terminals/scan-barcode/) camera

## Get started

These are the steps to get your new S1E2L payment terminal up and running. Some steps include a link to more detailed instructions.
...
Your S1E2L terminal can automatically switch to processing payments using a cellular connection when the internet connection fails. Adyen terminals come with a pre-installed and activated SIM (eSIM) card, so you can use the cellular network immediately to board the terminal.\
...
The S1E2L payment terminal is supplied with a USB-C charging cable and a region-specific power plug. This cable is compliant with the [USB industry](https://usb.org/) and [UL](https://www.ul.com/industries/products-and-components/wire-and-cable) standards.
