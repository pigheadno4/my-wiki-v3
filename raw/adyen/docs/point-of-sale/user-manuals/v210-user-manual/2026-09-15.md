<!-- Source URL: https://docs.adyen.com/point-of-sale/user-manuals/v210-user-manual.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "V210 user manual"
description: "Get started with the V210 payment terminal."
url: "https://docs.adyen.com/point-of-sale/user-manuals/v210-user-manual"
source_url: "https://docs.adyen.com/point-of-sale/user-manuals/v210-user-manual.md"
canonical: "https://docs.adyen.com/point-of-sale/user-manuals/v210-user-manual"
...
Get started with the V210 payment terminal.

Print this page

![](/user/pages/reuse/terminal-manuals/photos/noText_V210.png)
...
* V210 payment terminal
* Power supply
* SIM card
* Receipt paper roll 57 x 40 mm (Width x Diameter)

You can order new paper rolls in the Adyen [Customer Area](https://ca-live.adyen.com/), under **Devices** > **Orders & returns**.

## Get started

These are the steps to get your new V210 payment terminal up and running. Some steps include a link to more detailed instructions.
...
Your V210 terminal can automatically switch to processing payments using a cellular connection when the internet connection fails. Adyen terminals come with a pre-installed and activated SIM (eSIM) card, so you can use the cellular network immediately to board the terminal.\
...
2. On the back of the terminal, push the latch down and lift the cover.
