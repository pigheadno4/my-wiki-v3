<!-- Source URL: https://docs.adyen.com/point-of-sale/user-manuals/s1f2-user-manual.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "S1F2 user manual"
description: "Get started with the S1F2 payment terminal."
url: "https://docs.adyen.com/point-of-sale/user-manuals/s1f2-user-manual"
source_url: "https://docs.adyen.com/point-of-sale/user-manuals/s1f2-user-manual.md"
canonical: "https://docs.adyen.com/point-of-sale/user-manuals/s1f2-user-manual"
...
![](/user/pages/reuse/terminal-manuals/photos/noText_S1F2.png)
...
* S1F2 payment terminal
  ...
  * **S1F2L**: has a [barcode scanning](/point-of-sale/android-terminals/scan-barcode/) camera
...
3. Turn on the terminal: [connect the terminal](#cable-management) to a power supply, then press and hold the power button until the display turns on.\
...
Your S1F2 terminal can automatically switch to processing payments using a cellular connection when the internet connection fails. Adyen terminals come with a pre-installed and activated SIM (eSIM) card, so you can use the cellular network immediately to board the terminal.\
...
3. To access the SIM card slot, on the left side of the battery push the latch upwards and remove the battery.
...
The S1F2 payment terminal is supplied with a USB-C charging cable and a region-specific power plug. This cable is compliant with the [USB industry](https://usb.org/) and [UL](https://www.ul.com/industries/products-and-components/wire-and-cable) standards.
