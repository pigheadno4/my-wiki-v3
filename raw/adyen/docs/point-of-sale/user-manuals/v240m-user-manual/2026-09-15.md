<!-- Source URL: https://docs.adyen.com/point-of-sale/user-manuals/v240m-user-manual.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "V240m Plus user manual"
description: "Get started with the V240m Plus payment terminal."
url: "https://docs.adyen.com/point-of-sale/user-manuals/v240m-user-manual"
source_url: "https://docs.adyen.com/point-of-sale/user-manuals/v240m-user-manual.md"
canonical: "https://docs.adyen.com/point-of-sale/user-manuals/v240m-user-manual"
last_modified: "2019-07-25T13:59:00+02:00"
language: "en"
---

# V240m Plus user manual

Get started with the V240m Plus payment terminal.
...
![](/user/pages/reuse/terminal-manuals/photos/noText_V240-plus.png)
...
In your [Customer Area](https://ca-live.adyen.com/), under **Devices** > **Orders & returns** you can order new paper rolls and optional accessories such as a standard charging base or Bluetooth base station with Ethernet capabilities.

## Get started

These are the steps to get your new V240m Plus payment terminal up and running. Some steps include a link to more detailed instructions.
...
Your V240m Plus terminal can automatically switch to processing payments using a cellular connection when the internet connection fails. Adyen terminals come with a pre-installed and activated SIM (eSIM) card, so you can use the cellular network immediately to board the terminal.\
