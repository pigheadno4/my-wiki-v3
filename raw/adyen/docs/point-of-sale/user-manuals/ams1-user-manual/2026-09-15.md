<!-- Source URL: https://docs.adyen.com/point-of-sale/user-manuals/ams1-user-manual.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "AMS1 user manual"
description: "Get started with the AMS1 payment terminal."
url: "https://docs.adyen.com/point-of-sale/user-manuals/ams1-user-manual"
source_url: "https://docs.adyen.com/point-of-sale/user-manuals/ams1-user-manual.md"
canonical: "https://docs.adyen.com/point-of-sale/user-manuals/ams1-user-manual"
last_modified: "2025-12-15T10:12:00+01:00"
language: "en"
---

# AMS1 user manual

Get started with the AMS1 payment terminal.

Print this page

![](/user/pages/reuse/terminal-manuals/photos/noText_ams1.png)
...
These are the steps to get your new AMS1 payment terminal up and running. Some steps include a link to more detailed instructions.
...
The AMS1 payment terminal is supplied with a USB-C charging cable and a region-specific power plug. This cable is compliant with the [USB industry](https://usb.org/) and [UL](https://www.ul.com/industries/products-and-components/wire-and-cable) standards.
...
![](/user/pages/reuse/terminal-manuals/cable-management/ucb-c-charger-1.svg?decoding=auto\&fetchpriority=auto)

![](/user/pages/reuse/terminal-manuals/cable-management/ucb-c-charger-2.svg?decoding=auto\&fetchpriority=auto)
...
| ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ![](/user/pages/docs/03.point-of-sale/48.user-manuals/14.ams1-user-manual/menu-settings.png) **Settings**         | * **Device info**: view information about the payment terminal, like the serial number, configuration version, and store details. Update the software version. Scan to connect to the terminal.
...
- [Admin & Settings](/point-of-sale/menu-access?tab=manage_passcodes_in_the_customer_area_1#manage-passcodes) passcode required:
  ...
  * **Power**                   |
| ![](/user/pages/docs/03.point-of-sale/48.user-manuals/14.ams1-user-manual/menu-transactions.png) **Transactions** | * **History**: view transactions stored on the terminal.
