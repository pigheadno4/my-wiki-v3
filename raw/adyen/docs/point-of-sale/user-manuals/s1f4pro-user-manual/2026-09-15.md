<!-- Source URL: https://docs.adyen.com/point-of-sale/user-manuals/s1f4pro-user-manual.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->

---
title: "S1F4Pro user manual"
description: "Get started with the S1F4Pro payment terminal."
url: "https://docs.adyen.com/point-of-sale/user-manuals/s1f4pro-user-manual"
source_url: "https://docs.adyen.com/point-of-sale/user-manuals/s1f4pro-user-manual.md"
canonical: "https://docs.adyen.com/point-of-sale/user-manuals/s1f4pro-user-manual"
last_modified: "2024-12-16T11:18:00+01:00"
language: "en"
---

# S1F4Pro user manual

Get started with the S1F4Pro payment terminal.

Print this page

![](/user/pages/reuse/terminal-manuals/photos/S1F4Pro.png)

### Supplied components

* S1F4Pro payment terminal
* USB cable and region-specific power plug for charging
* eSIM card
* Receipt paper roll

In your [Customer Area](https://ca-test.adyen.com/), under **Devices** > **Orders & returns** you can order new paper rolls.

The S1F4Pro terminal has a barcode scanner button, but this is not functional. Instead, the terminal supports scanning through the built-in camera. Scanning using the camera can be started from the Android app on the terminal (if implemented by your organization).

## Get started

These are the steps to get your new S1F4Pro payment terminal up and running. Some steps include a link to more detailed instructions.
...
Your S1F4Pro terminal can automatically switch to processing payments using a cellular connection when the internet connection fails. Adyen terminals come with a pre-installed and activated SIM (eSIM) card, so you can use the cellular network immediately to board the terminal.\
...
The S1F4Pro payment terminal is supplied with a USB-C charging cable. This cable is compliant with the [USB industry](https://usb.org/) and [UL](https://www.ul.com/industries/products-and-components/wire-and-cable) standards.
...
- [Admin & Settings](/point-of-sale/menu-access?tab=manage_passcodes_in_the_customer_area_1#manage-passcodes) passcode required:
  ...
  * **Power**                  |
| ![](/user/pages/reuse/terminal-manuals/android-menus/menu-transactions.png) **Transactions** | * **History**: view transactions stored on the terminal. Re-print the merchant/shopper receipt for an approved transaction.
...
3. You can now:
   ...
   * Print the Totals report by selecting the print button:\
     ![](/user/pages/reuse/terminal-manuals/android-totals/bttn-receipt.svg?decoding=auto\&fetchpriority=auto)
...
If you will be using the payment terminal as a standalone terminal, transactions are not initiated from a POS system. Instead, you start transactions using the **Payment** button.\
