<!-- Source URL: https://docs.adyen.com/api-explorer/Checkout/latest/overview.md -->
<!-- Fetched: 2026-09-14 -->
<!-- Discovery: llms.txt -->

# Adyen Checkout API v72
...
Have a look at the [release notes](https://docs.adyen.com/online-payments/release-notes?integration_type=api&version=72) to find out what changed in this version!
...
| PATCH | /sessions/{sessionId} | Update a payment session |
