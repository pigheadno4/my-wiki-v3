<!-- Source URL: https://docs.adyen.com/api-explorer/Payment/latest/post/capture.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
| modificationAmount | object | Yes | The amount that needs to be captured. The `currency` must match the currency used in authorisation, the `value` must be smaller than or equal to the authorised amount. |
