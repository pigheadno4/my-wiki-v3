<!-- Source URL: https://docs.adyen.com/api-explorer/BalanceControlv1/latest/overview.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
Note that when going live, you must generate API credentials to access the [live endpoints](https://docs.adyen.com/development-resources/live-endpoints).
