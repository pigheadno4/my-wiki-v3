<!-- Source URL: https://docs.adyen.com/api-explorer/capital/latest/overview.md -->
<!-- Fetched: 2026-09-15 -->
<!-- Discovery: llms.txt -->
...
| POST | /dynamicOffers/{id}/calculate | Calculate a preliminary offer for a selected financing amount |
| POST | /dynamicOffers/{id}/grantOffer | Create a static offer for a selected financing amount |
| GET | /grantAccounts/{id} | Get the information of your grant account |
| GET | /grantOffers | Get all available static offers |
| GET | /grantOffers/{id} | Get the details of a static offer |
| GET | /grants | Get all the grants of an account holder |
| POST | /grants | Make a request for a grant |
| GET | /grants/{grantId} | Get the details of a grant |
| GET | /grants/{grantId}/disbursements | Get all the disbursements of a grant |
| GET | /grants/{grantId}/disbursements/{disbursementId} | Get disbursement details |
| PATCH | /grants/{grantId}/disbursements/{disbursementId} | Update the repayment configuration of a disbursement |
