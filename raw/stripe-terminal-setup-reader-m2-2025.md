<!-- Source: Stripe Terminal — Set up Stripe Reader M2 -->
<!-- Fetched: 2026-04-24 -->

# Set up Stripe Reader M2

Learn how to set up the Stripe Reader M2.
![](assets/stripe-terminal-m2-reader.png)
