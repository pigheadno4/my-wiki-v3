---
title: Integrate iDEAL using the JavaScript SDK
slug: /docs/checkout/apm/ideal/js-sdk/
createTime: "2024-12-03T10:20:33.653Z"
updateTime: "2025-03-28T03:26:44.701Z"
---

# Integrate iDEAL using the JavaScript SDK
...
- Request approval to enable iDEAL by visiting these sandbox and live links: - Sandbox: [https://www.sandbox.paypal.com/bizsignup/entry?product=ideal&capabilities=IDEAL&country.x=&lt;merchant's country&gt;](https://www.sandbox.paypal.com/bizsignup/entry?product=ideal&capabilities=IDEAL&country.x=)
...
- Request approval to enable iDEAL by visiting these sandbox and live links. Replace MERCHANT-COUNTRY in the URL with the 2-character [country code](https://developer.paypal.com/api/rest/reference/country-codes/) for the merchant's country of operation: - Sandbox: https://www.sandbox.paypal.com/bizsignup/entry?product=ideal&capabilities=IDEAL&country.x=MERCHANT-COUNTRY
...
#### **`Add PayPal JavaScript SDK /docs/checkout/apm/ideal/js-sdk/`**
...
![image](assets/paypal-apm-ideal-mark.png)

#### **`Render payment mark /docs/checkout/apm/ideal/js-sdk/`**
...
#### **`iDEAL payments Single page checkout flow`**
...
Partners need to onboard merchants upfront [before they accept payments](/docs/multiparty/seller-onboarding/before-payment/) . iDEAL doesn't support onboarding after making payments, specifically Progressive Onboarding. See the \*\*\*\* [Onboard a merchant](/docs/checkout/apm/ideal/#onboard-a-merchant-for-ideal-payments) section for more details.
