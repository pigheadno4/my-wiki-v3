<!-- Source URL: https://docs.stripe.com/elements/link-authentication-element -->
<!-- Fetched: 2026-04-21 -->
...
![A checkout page that includes the Link Authentication Element, Address Element, and Payment Element.](assets/stripe-link-authentication-element-with-ae-pe.png)
...
![Examples of light and dark modes for the payment element checkout form.](assets/stripe-elements-appearance-example.png)
