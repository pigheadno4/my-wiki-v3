<!-- Source: Stripe Checkout — Dynamically customize shipping options -->
<!-- Fetched: 2026-04-20 -->
...
- Set the [ui_mode](https://docs.stripe.com/api/checkout/sessions/create.md#create_checkout_session-ui_mode) to `embedded_page`.
...
> Always return a `Promise` from your `onShippingDetailsChange` function and resolve it with a [ResultAction](https://docs.stripe.com/js/embedded_checkout/create#embedded_checkout_create-options-onShippingDetailsChange-ResultAction) object.
