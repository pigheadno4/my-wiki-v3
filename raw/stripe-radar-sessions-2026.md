<!-- Source URL: https://docs.stripe.com/radar/radar-session -->
<!-- Fetched: 2026-05-10 -->
...
If you have an existing Payment Intent, you can attach a Radar Session to it when it’s _confirmed_ (Confirming an intent indicates that the customer intends to use the current or provided payment method. Upon confirmation, the intent attempts to initiate the portions of the flow that have real-world side effects).
