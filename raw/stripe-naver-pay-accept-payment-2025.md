<!-- Source URL: https://docs.stripe.com/payments/naver-pay/accept-a-payment -->
<!-- Fetched: 2026-05-08 -->

# Accept a payment using Naver Pay in South Korea

Learn how to accept payments from Naver Pay users.

# Checkout

> This is a Checkout for when payment-ui is checkout. View the full page at https://docs.stripe.com/payments/naver-pay/accept-a-payment?payment-ui=checkout.
...
- The minimum amount accepted is 100 KRW. There is no maximum limit for card passthrough transactions, while the maximum amount that a customer can top up to their Naver Pay account as stored value is 2,000,000 KRW.
...
> This is a Direct API for when payment-ui is direct-api. View the full page at https://docs.stripe.com/payments/naver-pay/accept-a-payment?payment-ui=direct-api.
...
## Add Naver Pay branding to your website

When incorporating Naver Pay branding into your website, you must comply with the Naver Pay [brand guidelines](https://developers.pay.naver.com/design/brand/overseas).
